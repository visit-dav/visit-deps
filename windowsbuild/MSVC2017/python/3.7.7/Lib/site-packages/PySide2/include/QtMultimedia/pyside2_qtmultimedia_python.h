...
enum : int {
    ...
    SBK_QTMULTIMEDIA_QLIST_QMEDIACONTENT_IDX                 = 19, // const QList<QMediaContent > &
    SBK_QTMULTIMEDIA_QLIST_QMEDIATIMEINTERVAL_IDX            = 20, // QList<QMediaTimeInterval >
    SBK_QTMULTIMEDIA_QPAIR_INT_INT_IDX                       = 21, // QPair<int,int >
    SBK_QtMultimedia_CONVERTERS_IDX_COUNT                    = 22
};

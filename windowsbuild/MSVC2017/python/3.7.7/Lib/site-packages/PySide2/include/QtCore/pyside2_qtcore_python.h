...
enum : int {
    ...
    SBK_QFLAGS_QABSTRACTITEMMODEL_CHECKINDEXOPTION_IDX       = 94,
    ...
    SBK_QFLAGS_QBYTEARRAY_BASE64OPTION_IDX                   = 95,
    SBK_QBYTEARRAYMATCHER_IDX                                = 23,
    SBK_QCALENDAR_IDX                                        = 24,
    SBK_QCALENDAR_SYSTEM_IDX                                 = 25,
    SBK_QCALENDAR_YEARMONTHDAY_IDX                           = 26,
    SBK_QCBORARRAY_IDX                                       = 27,
    SBK_QCBORERROR_IDX                                       = 28,
    SBK_QCBORERROR_CODE_IDX                                  = 29,
    SBK_QCBORMAP_IDX                                         = 31,
    SBK_QCBORPARSERERROR_IDX                                 = 32,
    SBK_QCBORSTREAMREADER_IDX                                = 34,
    SBK_QCBORSTREAMREADER_TYPE_IDX                           = 36,
    SBK_QCBORSTREAMREADER_STRINGRESULTCODE_IDX               = 35,
    SBK_QCBORSTREAMWRITER_IDX                                = 37,
    SBK_QCBORSTRINGRESULTBYTEARRAY_IDX                       = 38,
    SBK_QCBORSTREAMREADER_STRINGRESULT_QBYTEARRAY_IDX        = 38,
    SBK_QCBORSTRINGRESULTSTRING_IDX                          = 39,
    SBK_QCBORSTREAMREADER_STRINGRESULT_QSTRING_IDX           = 39,
    SBK_QCBORVALUE_IDX                                       = 40,
    SBK_QCBORVALUE_ENCODINGOPTION_IDX                        = 42,
    SBK_QFLAGS_QCBORVALUE_ENCODINGOPTION_IDX                 = 97,
    SBK_QCBORVALUE_DIAGNOSTICNOTATIONOPTION_IDX              = 41,
    SBK_QFLAGS_QCBORVALUE_DIAGNOSTICNOTATIONOPTION_IDX       = 96,
    SBK_QCBORVALUE_TYPE_IDX                                  = 43,
    SBK_QCHILDEVENT_IDX                                      = 44,
    SBK_QCOLLATOR_IDX                                        = 45,
    SBK_QCOLLATORSORTKEY_IDX                                 = 46,
    SBK_QCOMMANDLINEOPTION_IDX                               = 47,
    SBK_QCOMMANDLINEOPTION_FLAG_IDX                          = 48,
    SBK_QFLAGS_QCOMMANDLINEOPTION_FLAG_IDX                   = 98,
    SBK_QCOMMANDLINEPARSER_IDX                               = 49,
    SBK_QCOMMANDLINEPARSER_SINGLEDASHWORDOPTIONMODE_IDX      = 51,
    SBK_QCOMMANDLINEPARSER_OPTIONSAFTERPOSITIONALARGUMENTSMODE_IDX = 50,
    SBK_QCONCATENATETABLESPROXYMODEL_IDX                     = 52,
    SBK_QCOREAPPLICATION_IDX                                 = 53,
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 416,
    SBK_QCRYPTOGRAPHICHASH_IDX                               = 54,
    SBK_QCRYPTOGRAPHICHASH_ALGORITHM_IDX                     = 55,
    SBK_QDATASTREAM_IDX                                      = 56,
    SBK_QDATASTREAM_VERSION_IDX                              = 60,
    SBK_QDATASTREAM_BYTEORDER_IDX                            = 57,
    SBK_QDATASTREAM_STATUS_IDX                               = 59,
    SBK_QDATASTREAM_FLOATINGPOINTPRECISION_IDX               = 58,
    SBK_QDATE_IDX                                            = 61,
    SBK_QDATE_MONTHNAMETYPE_IDX                              = 62,
    SBK_QDATETIME_IDX                                        = 63,
    SBK_QDATETIME_YEARRANGE_IDX                              = 64,
    SBK_QDEADLINETIMER_IDX                                   = 65,
    SBK_QDEADLINETIMER_FOREVERCONSTANT_IDX                   = 66,
    SBK_QDIR_IDX                                             = 67,
    SBK_QDIR_FILTER_IDX                                      = 68,
    SBK_QFLAGS_QDIR_FILTER_IDX                               = 99,
    SBK_QDIR_SORTFLAG_IDX                                    = 69,
    SBK_QFLAGS_QDIR_SORTFLAG_IDX                             = 100,
    SBK_QDIRITERATOR_IDX                                     = 70,
    SBK_QDIRITERATOR_ITERATORFLAG_IDX                        = 71,
    SBK_QFLAGS_QDIRITERATOR_ITERATORFLAG_IDX                 = 101,
    SBK_QDYNAMICPROPERTYCHANGEEVENT_IDX                      = 72,
    SBK_QEASINGCURVE_IDX                                     = 73,
    SBK_QEASINGCURVE_TYPE_IDX                                = 74,
    SBK_QELAPSEDTIMER_IDX                                    = 75,
    SBK_QELAPSEDTIMER_CLOCKTYPE_IDX                          = 76,
    SBK_QEVENT_IDX                                           = 77,
    SBK_QEVENT_TYPE_IDX                                      = 78,
    SBK_QEVENTLOOP_IDX                                       = 79,
    SBK_QEVENTLOOP_PROCESSEVENTSFLAG_IDX                     = 80,
    SBK_QFLAGS_QEVENTLOOP_PROCESSEVENTSFLAG_IDX              = 102,
    SBK_QEVENTTRANSITION_IDX                                 = 81,
    SBK_QFACTORYINTERFACE_IDX                                = 82,
    SBK_QFILE_IDX                                            = 83,
    SBK_QFILEDEVICE_IDX                                      = 84,
    SBK_QFILEDEVICE_FILEERROR_IDX                            = 85,
    SBK_QFILEDEVICE_FILETIME_IDX                             = 87,
    SBK_QFILEDEVICE_PERMISSION_IDX                           = 89,
    SBK_QFLAGS_QFILEDEVICE_PERMISSION_IDX                    = 104,
    SBK_QFILEDEVICE_FILEHANDLEFLAG_IDX                       = 86,
    SBK_QFLAGS_QFILEDEVICE_FILEHANDLEFLAG_IDX                = 103,
    SBK_QFILEDEVICE_MEMORYMAPFLAGS_IDX                       = 88,
    SBK_QFILEINFO_IDX                                        = 90,
    SBK_QFILESELECTOR_IDX                                    = 91,
    SBK_QFILESYSTEMWATCHER_IDX                               = 92,
    SBK_QFINALSTATE_IDX                                      = 93,
    SBK_QGENERICARGUMENT_IDX                                 = 141,
    SBK_QGENERICRETURNARGUMENT_IDX                           = 142,
    SBK_QHISTORYSTATE_IDX                                    = 143,
    SBK_QHISTORYSTATE_HISTORYTYPE_IDX                        = 144,
    SBK_QIODEVICE_IDX                                        = 145,
    SBK_QIODEVICE_OPENMODEFLAG_IDX                           = 146,
    SBK_QFLAGS_QIODEVICE_OPENMODEFLAG_IDX                    = 105,
    SBK_QIDENTITYPROXYMODEL_IDX                              = 147,
    SBK_QITEMSELECTION_IDX                                   = 148,
    SBK_QLIST_QITEMSELECTIONRANGE_IDX                        = 148,
    SBK_QITEMSELECTIONMODEL_IDX                              = 149,
    SBK_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX                = 150,
    SBK_QFLAGS_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX         = 106,
    SBK_QITEMSELECTIONRANGE_IDX                              = 151,
    SBK_QJSONARRAY_IDX                                       = 152,
    SBK_QJSONDOCUMENT_IDX                                    = 153,
    SBK_QJSONDOCUMENT_DATAVALIDATION_IDX                     = 154,
    ...
    SBK_QLIBRARYINFO_IDX                                     = 160,
    SBK_QLIBRARYINFO_LIBRARYLOCATION_IDX                     = 161,
    SBK_QLINE_IDX                                            = 162,
    SBK_QLINEF_IDX                                           = 163,
    SBK_QLINEF_INTERSECTTYPE_IDX                             = 164,
    SBK_QLOCALE_IDX                                          = 165,
    SBK_QLOCALE_LANGUAGE_IDX                                 = 170,
    SBK_QLOCALE_SCRIPT_IDX                                   = 419,
    SBK_QLOCALE_COUNTRY_IDX                                  = 166,
    SBK_QLOCALE_MEASUREMENTSYSTEM_IDX                        = 171,
    SBK_QLOCALE_FORMATTYPE_IDX                               = 169,
    SBK_QLOCALE_NUMBEROPTION_IDX                             = 172,
    SBK_QFLAGS_QLOCALE_NUMBEROPTION_IDX                      = 108,
    SBK_QLOCALE_FLOATINGPOINTPRECISIONOPTION_IDX             = 168,
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 417,
    SBK_QLOCALE_DATASIZEFORMAT_IDX                           = 167,
    SBK_QFLAGS_QLOCALE_DATASIZEFORMAT_IDX                    = 107,
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 418,
    SBK_QLOCKFILE_IDX                                        = 173,
    SBK_QLOCKFILE_LOCKERROR_IDX                              = 174,
    SBK_QMARGINS_IDX                                         = 175,
    SBK_QMARGINSF_IDX                                        = 176,
    SBK_QMESSAGEAUTHENTICATIONCODE_IDX                       = 177,
    SBK_QMESSAGELOGCONTEXT_IDX                               = 178,
    SBK_QMETACLASSINFO_IDX                                   = 179,
    SBK_QMETAENUM_IDX                                        = 180,
    SBK_QMETAMETHOD_IDX                                      = 181,
    SBK_QMETAMETHOD_ACCESS_IDX                               = 182,
    SBK_QMETAMETHOD_METHODTYPE_IDX                           = 183,
    SBK_QMETAOBJECT_IDX                                      = 184,
    SBK_QMETAOBJECT_CALL_IDX                                 = 185,
    SBK_QMETAOBJECT_CONNECTION_IDX                           = 186,
    SBK_QMETAPROPERTY_IDX                                    = 187,
    SBK_QMIMEDATA_IDX                                        = 188,
    SBK_QMIMEDATABASE_IDX                                    = 189,
    SBK_QMIMEDATABASE_MATCHMODE_IDX                          = 190,
    SBK_QMIMETYPE_IDX                                        = 191,
    SBK_QMODELINDEX_IDX                                      = 192,
    SBK_QMUTEX_IDX                                           = 193,
    SBK_QMUTEX_RECURSIONMODE_IDX                             = 194,
    SBK_QMUTEXLOCKER_IDX                                     = 195,
    SBK_QOBJECT_IDX                                          = 196,
    SBK_QOPERATINGSYSTEMVERSION_IDX                          = 197,
    SBK_QOPERATINGSYSTEMVERSION_OSTYPE_IDX                   = 198,
    SBK_QPARALLELANIMATIONGROUP_IDX                          = 199,
    SBK_QPAUSEANIMATION_IDX                                  = 200,
    SBK_QPERSISTENTMODELINDEX_IDX                            = 201,
    SBK_QPLUGINLOADER_IDX                                    = 202,
    SBK_QPOINT_IDX                                           = 203,
    SBK_QPOINTF_IDX                                          = 204,
    SBK_QPROCESS_IDX                                         = 205,
    SBK_QPROCESS_PROCESSERROR_IDX                            = 210,
    SBK_QPROCESS_PROCESSSTATE_IDX                            = 211,
    SBK_QPROCESS_PROCESSCHANNEL_IDX                          = 208,
    SBK_QPROCESS_PROCESSCHANNELMODE_IDX                      = 209,
    SBK_QPROCESS_INPUTCHANNELMODE_IDX                        = 207,
    SBK_QPROCESS_EXITSTATUS_IDX                              = 206,
    SBK_QPROCESSENVIRONMENT_IDX                              = 212,
    SBK_QPROPERTYANIMATION_IDX                               = 213,
    SBK_QRANDOMGENERATOR_IDX                                 = 214,
    SBK_QRANDOMGENERATOR64_IDX                               = 215,
    SBK_QREADLOCKER_IDX                                      = 216,
    SBK_QREADWRITELOCK_IDX                                   = 217,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 218,
    SBK_QRECT_IDX                                            = 219,
    SBK_QRECTF_IDX                                           = 220,
    SBK_QRECURSIVEMUTEX_IDX                                  = 221,
    SBK_QREGEXP_IDX                                          = 222,
    SBK_QREGEXP_PATTERNSYNTAX_IDX                            = 224,
    SBK_QREGEXP_CARETMODE_IDX                                = 223,
    SBK_QREGULAREXPRESSION_IDX                               = 225,
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 228,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 110,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 227,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 226,
    SBK_QFLAGS_QREGULAREXPRESSION_MATCHOPTION_IDX            = 109,
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 229,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 230,
    SBK_QRESOURCE_IDX                                        = 231,
    SBK_QRESOURCE_COMPRESSION_IDX                            = 232,
    SBK_QRUNNABLE_IDX                                        = 233,
    SBK_QSAVEFILE_IDX                                        = 234,
    SBK_QSEMAPHORE_IDX                                       = 235,
    SBK_QSEMAPHORERELEASER_IDX                               = 236,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 237,
    SBK_QSETTINGS_IDX                                        = 238,
    SBK_QSETTINGS_STATUS_IDX                                 = 241,
    SBK_QSETTINGS_FORMAT_IDX                                 = 239,
    SBK_QSETTINGS_SCOPE_IDX                                  = 240,
    SBK_QSIGNALBLOCKER_IDX                                   = 242,
    SBK_QSIGNALMAPPER_IDX                                    = 243,
    SBK_QSIGNALTRANSITION_IDX                                = 244,
    SBK_QSIZE_IDX                                            = 245,
    SBK_QSIZEF_IDX                                           = 246,
    SBK_QSOCKETNOTIFIER_IDX                                  = 247,
    SBK_QSOCKETNOTIFIER_TYPE_IDX                             = 248,
    SBK_QSORTFILTERPROXYMODEL_IDX                            = 249,
    SBK_QSTANDARDPATHS_IDX                                   = 250,
    SBK_QSTANDARDPATHS_STANDARDLOCATION_IDX                  = 252,
    SBK_QSTANDARDPATHS_LOCATEOPTION_IDX                      = 251,
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 111,
    SBK_QSTATE_IDX                                           = 253,
    SBK_QSTATE_CHILDMODE_IDX                                 = 254,
    SBK_QSTATE_RESTOREPOLICY_IDX                             = 255,
    SBK_QSTATEMACHINE_IDX                                    = 256,
    SBK_QSTATEMACHINE_EVENTPRIORITY_IDX                      = 258,
    SBK_QSTATEMACHINE_ERROR_IDX                              = 257,
    SBK_QSTATEMACHINE_SIGNALEVENT_IDX                        = 259,
    SBK_QSTATEMACHINE_WRAPPEDEVENT_IDX                       = 260,
    SBK_QSTORAGEINFO_IDX                                     = 261,
    SBK_QSTRINGLISTMODEL_IDX                                 = 262,
    SBK_QSYSINFO_IDX                                         = 263,
    SBK_QSYSINFO_SIZES_IDX                                   = 265,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 264,
    SBK_QSYSINFO_WINVERSION_IDX                              = 266,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 267,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 268,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 269,
    SBK_QTEMPORARYDIR_IDX                                    = 270,
    SBK_QTEMPORARYFILE_IDX                                   = 271,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 272,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 274,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 273,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 112,
    SBK_QTEXTCODEC_IDX                                       = 275,
    SBK_QTEXTCODEC_CONVERSIONFLAG_IDX                        = 276,
    SBK_QFLAGS_QTEXTCODEC_CONVERSIONFLAG_IDX                 = 113,
    SBK_QTEXTCODEC_CONVERTERSTATE_IDX                        = 277,
    SBK_QTEXTDECODER_IDX                                     = 278,
    SBK_QTEXTENCODER_IDX                                     = 279,
    SBK_QTEXTSTREAM_IDX                                      = 280,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 283,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 281,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 284,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 282,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 114,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 285,
    SBK_QTHREAD_IDX                                          = 286,
    SBK_QTHREAD_PRIORITY_IDX                                 = 287,
    SBK_QTHREADPOOL_IDX                                      = 288,
    SBK_QTIME_IDX                                            = 289,
    SBK_QTIMELINE_IDX                                        = 290,
    SBK_QTIMELINE_STATE_IDX                                  = 293,
    SBK_QTIMELINE_DIRECTION_IDX                              = 292,
    SBK_QTIMELINE_CURVESHAPE_IDX                             = 291,
    SBK_QTIMEZONE_IDX                                        = 294,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 297,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 295,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 296,
    SBK_QTIMER_IDX                                           = 298,
    SBK_QTIMEREVENT_IDX                                      = 299,
    SBK_QTRANSLATOR_IDX                                      = 300,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 301,
    SBK_QURL_IDX                                             = 302,
    SBK_QURL_PARSINGMODE_IDX                                 = 304,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 305,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 303,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 115,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 306,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 117,
    SBK_QURLQUERY_IDX                                        = 307,
    SBK_QUUID_IDX                                            = 308,
    SBK_QUUID_VARIANT_IDX                                    = 310,
    SBK_QUUID_VERSION_IDX                                    = 311,
    SBK_QUUID_STRINGFORMAT_IDX                               = 309,
    SBK_QVARIANTANIMATION_IDX                                = 312,
    SBK_QVERSIONNUMBER_IDX                                   = 313,
    SBK_QWAITCONDITION_IDX                                   = 314,
    SBK_QWINEVENTNOTIFIER_IDX                                = 315,
    SBK_QWRITELOCKER_IDX                                     = 316,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 317,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 318,
    SBK_QVECTOR_QXMLSTREAMATTRIBUTE_IDX                      = 318,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 319,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 320,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 321,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 322,
    SBK_QXMLSTREAMREADER_IDX                                 = 323,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 326,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 325,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 324,
    SBK_QXMLSTREAMWRITER_IDX                                 = 327,
    SBK_QtCoreQT_IDX                                         = 328,
    SBK_QT_GLOBALCOLOR_IDX                                   = 362,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 373,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 129,
    SBK_QT_MODIFIER_IDX                                      = 377,
    SBK_QT_MOUSEBUTTON_IDX                                   = 378,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 131,
    SBK_QT_ORIENTATION_IDX                                   = 383,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 133,
    SBK_QT_FOCUSPOLICY_IDX                                   = 357,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 395,
    SBK_QT_SORTORDER_IDX                                     = 393,
    SBK_QT_SPLITBEHAVIORFLAGS_IDX                            = 394,
    SBK_QFLAGS_QT_SPLITBEHAVIORFLAGS_IDX                     = 135,
    SBK_QT_TILERULE_IDX                                      = 400,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 329,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 118,
    SBK_QT_TEXTFLAG_IDX                                      = 397,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 396,
    SBK_QT_WHITESPACEMODE_IDX                                = 409,
    SBK_QT_HITTESTACCURACY_IDX                               = 364,
    SBK_QT_WINDOWTYPE_IDX                                    = 414,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 140,
    SBK_QT_WINDOWSTATE_IDX                                   = 413,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 139,
    SBK_QT_APPLICATIONSTATE_IDX                              = 332,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 119,
    SBK_QT_SCREENORIENTATION_IDX                             = 387,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 134,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 410,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 331,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 365,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 125,
    SBK_QT_BGMODE_IDX                                        = 336,
    SBK_QT_KEY_IDX                                           = 372,
    SBK_QT_ARROWTYPE_IDX                                     = 333,
    SBK_QT_PENSTYLE_IDX                                      = 386,
    SBK_QT_PENCAPSTYLE_IDX                                   = 384,
    SBK_QT_PENJOINSTYLE_IDX                                  = 385,
    SBK_QT_BRUSHSTYLE_IDX                                    = 337,
    SBK_QT_SIZEMODE_IDX                                      = 392,
    SBK_QT_UIEFFECT_IDX                                      = 408,
    SBK_QT_CURSORSHAPE_IDX                                   = 346,
    SBK_QT_TEXTFORMAT_IDX                                    = 398,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 334,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 349,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 120,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 350,
    SBK_QT_TOOLBARAREA_IDX                                   = 403,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 137,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 404,
    SBK_QT_DATEFORMAT_IDX                                    = 347,
    SBK_QT_TIMESPEC_IDX                                      = 401,
    SBK_QT_DAYOFWEEK_IDX                                     = 348,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 388,
    SBK_QT_CASESENSITIVITY_IDX                               = 338,
    SBK_QT_CORNER_IDX                                        = 345,
    SBK_QT_EDGE_IDX                                          = 352,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 122,
    SBK_QT_CONNECTIONTYPE_IDX                                = 342,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 390,
    SBK_QT_FILLRULE_IDX                                      = 355,
    SBK_QT_MASKMODE_IDX                                      = 375,
    SBK_QT_CLIPOPERATION_IDX                                 = 341,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 370,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 371,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 407,
    SBK_QT_AXIS_IDX                                          = 335,
    SBK_QT_FOCUSREASON_IDX                                   = 358,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 343,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 367,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 127,
    SBK_QT_INPUTMETHODHINT_IDX                               = 366,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 126,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 353,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 405,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 374,
    SBK_QT_ANCHORPOINT_IDX                                   = 330,
    SBK_QT_FINDCHILDOPTION_IDX                               = 356,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 123,
    SBK_QT_DROPACTION_IDX                                    = 351,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 121,
    SBK_QT_CHECKSTATE_IDX                                    = 339,
    SBK_QT_ITEMDATAROLE_IDX                                  = 368,
    SBK_QT_ITEMFLAG_IDX                                      = 369,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 128,
    SBK_QT_MATCHFLAG_IDX                                     = 376,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 130,
    SBK_QT_WINDOWMODALITY_IDX                                = 412,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 399,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 136,
    SBK_QT_EVENTPRIORITY_IDX                                 = 354,
    SBK_QT_SIZEHINT_IDX                                      = 391,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 411,
    SBK_QT_COORDINATESYSTEM_IDX                              = 344,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 406,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 138,
    SBK_QT_GESTURESTATE_IDX                                  = 360,
    SBK_QT_GESTURETYPE_IDX                                   = 361,
    SBK_QT_GESTUREFLAG_IDX                                   = 359,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 124,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 381,
    SBK_QT_NAVIGATIONMODE_IDX                                = 382,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 420,
    SBK_QT_TIMERTYPE_IDX                                     = 402,
    SBK_QT_SCROLLPHASE_IDX                                   = 389,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 380,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 379,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 132,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 340,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 363,
    SBK_QCBORKNOWNTAGS_IDX                                   = 30,
    SBK_QCBORSIMPLETYPE_IDX                                  = 33,
    SBK_QTMSGTYPE_IDX                                        = 415,
    SBK_QtCore_IDX_COUNT                                     = 421
};
...
enum : int {
    ...
    SBK_QTCORE_QPAIR_QINT64_UNSIGNEDINT_IDX                  = 27, // QPair<qint64,unsigned int >
    SBK_QTCORE_QLIST_QFILEINFO_IDX                           = 28, // QList<QFileInfo >
    SBK_QTCORE_QVECTOR_QPOINTF_IDX                           = 29, // QVector<QPointF >
    SBK_QTCORE_QLIST_QITEMSELECTIONRANGE_IDX                 = 30, // const QList<QItemSelectionRange > &
    SBK_QTCORE_QSET_QITEMSELECTIONRANGE_IDX                  = 31, // const QSet<QItemSelectionRange > &
    SBK_QTCORE_QVECTOR_QITEMSELECTIONRANGE_IDX               = 32, // const QVector<QItemSelectionRange > &
    SBK_QTCORE_QLIST_QLOCALE_COUNTRY_IDX                     = 33, // QList<QLocale::Country >
    SBK_QTCORE_QLIST_QLOCALE_IDX                             = 34, // QList<QLocale >
    SBK_QTCORE_QLIST_QT_DAYOFWEEK_IDX                        = 35, // QList<Qt::DayOfWeek >
    SBK_QTCORE_QLIST_QURL_IDX                                = 36, // const QList<QUrl > &
    SBK_QTCORE_QLIST_QMIMETYPE_IDX                           = 37, // QList<QMimeType >
    SBK_QTCORE_QPAIR_QREAL_QVARIANT_IDX                      = 38, // QPair<qreal,QVariant >
    SBK_QTCORE_QVECTOR_QPAIR_QREAL_QVARIANT_IDX              = 39, // QVector<QPair< qreal,QVariant > >
    SBK_QTCORE_QLIST_QABSTRACTTRANSITIONPTR_IDX              = 40, // QList<QAbstractTransition* >
    SBK_QTCORE_QSET_QABSTRACTSTATEPTR_IDX                    = 41, // QSet<QAbstractState* >
    SBK_QTCORE_QLIST_QSTORAGEINFO_IDX                        = 42, // QList<QStorageInfo >
    SBK_QTCORE_QLIST_INT_IDX                                 = 43, // QList<int >
    SBK_QTCORE_QVECTOR_QTIMEZONE_OFFSETDATA_IDX              = 44, // QVector<QTimeZone::OffsetData >
    SBK_QTCORE_QPAIR_QSTRING_QSTRING_IDX                     = 45, // QPair<QString,QString >
    SBK_QTCORE_QLIST_QPAIR_QSTRING_QSTRING_IDX               = 46, // QList<QPair< QString,QString > >
    SBK_QTCORE_QVECTOR_QXMLSTREAMATTRIBUTE_IDX               = 47, // QVector<QXmlStreamAttribute > &
    SBK_QTCORE_QLIST_QXMLSTREAMATTRIBUTE_IDX                 = 48, // const QList<QXmlStreamAttribute > &
    SBK_QTCORE_QVECTOR_QXMLSTREAMNAMESPACEDECLARATION_IDX    = 49, // const QVector<QXmlStreamNamespaceDeclaration > &
    SBK_QTCORE_QVECTOR_QXMLSTREAMENTITYDECLARATION_IDX       = 50, // QVector<QXmlStreamEntityDeclaration >
    SBK_QTCORE_QVECTOR_QXMLSTREAMNOTATIONDECLARATION_IDX     = 51, // QVector<QXmlStreamNotationDeclaration >
    SBK_QTCORE_QLIST_QSTRING_IDX                             = 52, // QList<QString >
    SBK_QtCore_CONVERTERS_IDX_COUNT                          = 53
};

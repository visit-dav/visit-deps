...
enum : int {
    ...
    SBK_QHELPINDEXMODEL_IDX                                  = 8,
    SBK_QHELPINDEXWIDGET_IDX                                 = 9,
    SBK_QHELPSEARCHENGINE_IDX                                = 10,
    SBK_QHELPSEARCHQUERY_IDX                                 = 11,
    SBK_QHELPSEARCHQUERY_FIELDNAME_IDX                       = 12,
    SBK_QHELPSEARCHQUERYWIDGET_IDX                           = 13,
    SBK_QHELPSEARCHRESULT_IDX                                = 14,
    SBK_QHELPSEARCHRESULTWIDGET_IDX                          = 15,
    SBK_QtHelp_IDX_COUNT                                     = 16
};
...
// Converter indices
enum : int {
    SBK_QTHELP_QLIST_QOBJECTPTR_IDX                          = 0, // const QList<QObject* > &
    SBK_QTHELP_QVECTOR_INT_IDX                               = 1, // const QVector<int > &
    SBK_QTHELP_QHASH_INT_QBYTEARRAY_IDX                      = 2, // const QHash<int,QByteArray > &
    SBK_QTHELP_QLIST_QBYTEARRAY_IDX                          = 3, // QList<QByteArray >
    SBK_QTHELP_QMAP_INT_QVARIANT_IDX                         = 4, // QMap<int,QVariant >
    SBK_QTHELP_QLIST_QPERSISTENTMODELINDEX_IDX               = 5, // const QList<QPersistentModelIndex > &
    SBK_QTHELP_QLIST_QACTIONPTR_IDX                          = 6, // QList<QAction* >
    SBK_QTHELP_QLIST_QWIDGETPTR_IDX                          = 7, // QList<QWidget* >
    SBK_QTHELP_QLIST_QURL_IDX                                = 8, // QList<QUrl >
    SBK_QTHELP_QLIST_QSTRINGLIST_IDX                         = 9, // QList<QStringList >
    SBK_QTHELP_QMAP_QSTRING_QURL_IDX                         = 10, // QMap<QString,QUrl >
    SBK_QTHELP_QLIST_QVERSIONNUMBER_IDX                      = 11, // const QList<QVersionNumber > &

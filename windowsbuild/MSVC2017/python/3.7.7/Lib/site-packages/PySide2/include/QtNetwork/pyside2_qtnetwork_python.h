...
enum : int {
    ...
    SBK_QNETWORKSESSION_IDX                                  = 84,
    SBK_QNETWORKSESSION_STATE_IDX                            = 86,
    SBK_QNETWORKSESSION_SESSIONERROR_IDX                     = 85,
    SBK_QNETWORKSESSION_USAGEPOLICY_IDX                      = 87,
    SBK_QFLAGS_QNETWORKSESSION_USAGEPOLICY_IDX               = 30,
    SBK_QOCSPRESPONSE_IDX                                    = 89,
    SBK_QtNetworkQPASSWORDDIGESTOR_IDX                       = 91,
    SBK_QtNetworkQSSL_IDX                                    = 94,
    SBK_QSSL_KEYTYPE_IDX                                     = 98,
    SBK_QSSL_ENCODINGFORMAT_IDX                              = 96,
    SBK_QSSL_KEYALGORITHM_IDX                                = 97,
    SBK_QSSL_ALTERNATIVENAMEENTRYTYPE_IDX                    = 95,
    SBK_QSSL_SSLPROTOCOL_IDX                                 = 100,
    SBK_QSSL_SSLOPTION_IDX                                   = 99,
    SBK_QFLAGS_QSSL_SSLOPTION_IDX                            = 31,
    SBK_QSSLCERTIFICATE_IDX                                  = 101,
    ...
    SBK_QOCSPCERTIFICATESTATUS_IDX                           = 88,
    SBK_QOCSPREVOCATIONREASON_IDX                            = 90,

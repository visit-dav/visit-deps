...
enum : int {
    ...
    SBK_QTSQL_QVECTOR_INT_IDX                                = 3, // const QVector<int > &
    SBK_QTSQL_QHASH_INT_QBYTEARRAY_IDX                       = 4, // const QHash<int,QByteArray > &
    SBK_QTSQL_QMAP_INT_QVARIANT_IDX                          = 5, // QMap<int,QVariant >
    SBK_QTSQL_QLIST_QPERSISTENTMODELINDEX_IDX                = 6, // const QList<QPersistentModelIndex > &
    SBK_QTSQL_QVECTOR_QVARIANT_IDX                           = 7, // QVector<QVariant > &
    SBK_QTSQL_QLIST_QVARIANT_IDX                             = 8, // QList<QVariant >
    SBK_QTSQL_QLIST_QSTRING_IDX                              = 9, // QList<QString >
    SBK_QtSql_CONVERTERS_IDX_COUNT                           = 10
};

...
enum : int {
    ...
    SBK_QTCHARTS_QXYLEGENDMARKER_IDX                         = 67,
    SBK_QTCHARTS_QXYMODELMAPPER_IDX                          = 68,
    SBK_QTCHARTS_QXYSERIES_IDX                               = 69,
...
enum : int {
    ...
    SBK_QTCHARTS_QLIST_QWIDGETPTR_IDX                        = 10, // QList<QWidget* >
    SBK_QTCHARTS_QLIST_QRECTF_IDX                            = 11, // const QList<QRectF > &
    SBK_QTCHARTS_QLIST_QTCHARTS_QLEGENDMARKERPTR_IDX         = 12, // QList<QtCharts::QLegendMarker* >
    SBK_QTCHARTS_QLIST_QPOINTF_IDX                           = 13, // const QList<QPointF > &
    SBK_QTCHARTS_QVECTOR_QPOINTF_IDX                         = 14, // QVector<QPointF >
    SBK_QTCHARTS_QLIST_QTCHARTS_QPIESLICEPTR_IDX             = 15, // QList<QtCharts::QPieSlice* >
    SBK_QTCHARTS_QLIST_QVARIANT_IDX                          = 16, // QList<QVariant >
    SBK_QTCHARTS_QLIST_QSTRING_IDX                           = 17, // QList<QString >
    SBK_QTCHARTS_QMAP_QSTRING_QVARIANT_IDX                   = 18, // QMap<QString,QVariant >
    SBK_QtCharts_CONVERTERS_IDX_COUNT                        = 19
};

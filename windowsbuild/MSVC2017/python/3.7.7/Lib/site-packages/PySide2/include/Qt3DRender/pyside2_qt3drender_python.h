...
enum : int {
    ...
    SBK_QT3DRENDER_QATTRIBUTE_IDX                            = 23,
    SBK_QT3DRENDER_QATTRIBUTE_ATTRIBUTETYPE_IDX              = 24,
    SBK_QT3DRENDER_QATTRIBUTE_VERTEXBASETYPE_IDX             = 25,
    SBK_QT3DRENDER_QBLENDEQUATION_IDX                        = 26,
    SBK_QT3DRENDER_QBLENDEQUATION_BLENDFUNCTION_IDX          = 27,
    SBK_QT3DRENDER_QBLENDEQUATIONARGUMENTS_IDX               = 28,
    SBK_QT3DRENDER_QBLENDEQUATIONARGUMENTS_BLENDING_IDX      = 29,
    SBK_QT3DRENDER_QBLITFRAMEBUFFER_IDX                      = 30,
    SBK_QT3DRENDER_QBLITFRAMEBUFFER_INTERPOLATIONMETHOD_IDX  = 31,
    SBK_QT3DRENDER_QBUFFER_IDX                               = 32,
    SBK_QT3DRENDER_QBUFFER_BUFFERTYPE_IDX                    = 34,
    SBK_QT3DRENDER_QBUFFER_USAGETYPE_IDX                     = 35,
    SBK_QT3DRENDER_QBUFFER_ACCESSTYPE_IDX                    = 33,
    SBK_QT3DRENDER_QBUFFERCAPTURE_IDX                        = 36,
    SBK_QT3DRENDER_QBUFFERDATAGENERATOR_IDX                  = 37,
    SBK_QT3DRENDER_QCAMERA_IDX                               = 38,
    SBK_QT3DRENDER_QCAMERA_CAMERATRANSLATIONOPTION_IDX       = 39,
    SBK_QT3DRENDER_QCAMERALENS_IDX                           = 40,
    SBK_QT3DRENDER_QCAMERALENS_PROJECTIONTYPE_IDX            = 41,
    SBK_QT3DRENDER_QCAMERASELECTOR_IDX                       = 42,
    SBK_QT3DRENDER_QCLEARBUFFERS_IDX                         = 43,
    SBK_QT3DRENDER_QCLEARBUFFERS_BUFFERTYPE_IDX              = 44,
    SBK_QFLAGS_QT3DRENDER_QCLEARBUFFERS_BUFFERTYPE_IDX       = 0,
    SBK_QT3DRENDER_QCLIPPLANE_IDX                            = 45,
    SBK_QT3DRENDER_QCOLORMASK_IDX                            = 46,
    SBK_QT3DRENDER_QCOMPUTECOMMAND_IDX                       = 47,
    SBK_QT3DRENDER_QCOMPUTECOMMAND_RUNTYPE_IDX               = 48,
    SBK_QT3DRENDER_QCULLFACE_IDX                             = 49,
    SBK_QT3DRENDER_QCULLFACE_CULLINGMODE_IDX                 = 50,
    SBK_QT3DRENDER_QDEPTHTEST_IDX                            = 51,
    SBK_QT3DRENDER_QDEPTHTEST_DEPTHFUNCTION_IDX              = 52,
    SBK_QT3DRENDER_QDIRECTIONALLIGHT_IDX                     = 53,
    SBK_QT3DRENDER_QDISPATCHCOMPUTE_IDX                      = 54,
    SBK_QT3DRENDER_QDITHERING_IDX                            = 55,
    SBK_QT3DRENDER_QEFFECT_IDX                               = 56,
    SBK_QT3DRENDER_QENVIRONMENTLIGHT_IDX                     = 57,
    SBK_QT3DRENDER_QFILTERKEY_IDX                            = 58,
    SBK_QT3DRENDER_QFRAMEGRAPHNODE_IDX                       = 59,
    SBK_QT3DRENDER_QFRAMEGRAPHNODECREATEDCHANGEBASE_IDX      = 60,
    SBK_QT3DRENDER_QFRONTFACE_IDX                            = 61,
    SBK_QT3DRENDER_QFRONTFACE_WINDINGDIRECTION_IDX           = 62,
    SBK_QT3DRENDER_QFRUSTUMCULLING_IDX                       = 63,
    SBK_QT3DRENDER_QGEOMETRY_IDX                             = 64,
    SBK_QT3DRENDER_QGEOMETRYFACTORY_IDX                      = 65,
    SBK_QT3DRENDER_QGEOMETRYRENDERER_IDX                     = 66,
    SBK_QT3DRENDER_QGEOMETRYRENDERER_PRIMITIVETYPE_IDX       = 67,
    SBK_QT3DRENDER_QGRAPHICSAPIFILTER_IDX                    = 68,
    SBK_QT3DRENDER_QGRAPHICSAPIFILTER_API_IDX                = 69,
    SBK_QT3DRENDER_QGRAPHICSAPIFILTER_OPENGLPROFILE_IDX      = 70,
    SBK_QT3DRENDER_QLAYER_IDX                                = 71,
    SBK_QT3DRENDER_QLAYERFILTER_IDX                          = 72,
    SBK_QT3DRENDER_QLAYERFILTER_FILTERMODE_IDX               = 73,
    SBK_QT3DRENDER_QLEVELOFDETAIL_IDX                        = 74,
    SBK_QT3DRENDER_QLEVELOFDETAIL_THRESHOLDTYPE_IDX          = 75,
    SBK_QT3DRENDER_QLEVELOFDETAILBOUNDINGSPHERE_IDX          = 76,
    SBK_QT3DRENDER_QLEVELOFDETAILSWITCH_IDX                  = 77,
    SBK_QT3DRENDER_QLINEWIDTH_IDX                            = 78,
    SBK_QT3DRENDER_QMATERIAL_IDX                             = 79,
    SBK_QT3DRENDER_QMEMORYBARRIER_IDX                        = 80,
    SBK_QT3DRENDER_QMEMORYBARRIER_OPERATION_IDX              = 81,
    SBK_QFLAGS_QT3DRENDER_QMEMORYBARRIER_OPERATION_IDX       = 1,
    SBK_QT3DRENDER_QMESH_IDX                                 = 82,
    SBK_QT3DRENDER_QMESH_STATUS_IDX                          = 83,
    SBK_QT3DRENDER_QMULTISAMPLEANTIALIASING_IDX              = 84,
    SBK_QT3DRENDER_QNODEPTHMASK_IDX                          = 85,
    SBK_QT3DRENDER_QNODRAW_IDX                               = 86,
    SBK_QT3DRENDER_QNOPICKING_IDX                            = 87,
    SBK_QT3DRENDER_QOBJECTPICKER_IDX                         = 88,
    SBK_QT3DRENDER_QPAINTEDTEXTUREIMAGE_IDX                  = 89,
    SBK_QT3DRENDER_QPARAMETER_IDX                            = 90,
    SBK_QT3DRENDER_QPICKEVENT_IDX                            = 91,
    SBK_QT3DRENDER_QPICKEVENT_BUTTONS_IDX                    = 92,
    SBK_QT3DRENDER_QPICKEVENT_MODIFIERS_IDX                  = 93,
    SBK_QT3DRENDER_QPICKLINEEVENT_IDX                        = 94,
    SBK_QT3DRENDER_QPICKPOINTEVENT_IDX                       = 95,
    SBK_QT3DRENDER_QPICKTRIANGLEEVENT_IDX                    = 96,
    SBK_QT3DRENDER_QPICKINGSETTINGS_IDX                      = 97,
    SBK_QT3DRENDER_QPICKINGSETTINGS_PICKMETHOD_IDX           = 99,
    SBK_QT3DRENDER_QPICKINGSETTINGS_PICKRESULTMODE_IDX       = 100,
    SBK_QT3DRENDER_QPICKINGSETTINGS_FACEORIENTATIONPICKINGMODE_IDX = 98,
    SBK_QT3DRENDER_QPOINTLIGHT_IDX                           = 101,
    SBK_QT3DRENDER_QPOINTSIZE_IDX                            = 102,
    SBK_QT3DRENDER_QPOINTSIZE_SIZEMODE_IDX                   = 103,
    SBK_QT3DRENDER_QPOLYGONOFFSET_IDX                        = 104,
    SBK_QT3DRENDER_QPROXIMITYFILTER_IDX                      = 105,
    SBK_QT3DRENDER_QRAYCASTER_IDX                            = 106,
    SBK_QT3DRENDER_QRAYCASTERHIT_IDX                         = 107,
    SBK_QT3DRENDER_QRAYCASTERHIT_HITTYPE_IDX                 = 108,
    SBK_QT3DRENDER_QRENDERASPECT_IDX                         = 109,
    SBK_QT3DRENDER_QRENDERASPECT_RENDERTYPE_IDX              = 110,
    SBK_QT3DRENDER_QRENDERCAPTURE_IDX                        = 111,
    SBK_QT3DRENDER_QRENDERCAPTUREREPLY_IDX                   = 112,
    SBK_QT3DRENDER_QRENDERPASS_IDX                           = 113,
    SBK_QT3DRENDER_QRENDERPASSFILTER_IDX                     = 114,
    SBK_QT3DRENDER_QRENDERSETTINGS_IDX                       = 115,
    SBK_QT3DRENDER_QRENDERSETTINGS_RENDERPOLICY_IDX          = 116,
    SBK_QT3DRENDER_QRENDERSTATE_IDX                          = 117,
    SBK_QT3DRENDER_QRENDERSTATESET_IDX                       = 118,
    SBK_QT3DRENDER_QRENDERSURFACESELECTOR_IDX                = 119,
    SBK_QT3DRENDER_QRENDERTARGET_IDX                         = 120,
    SBK_QT3DRENDER_QRENDERTARGETOUTPUT_IDX                   = 121,
    SBK_QT3DRENDER_QRENDERTARGETOUTPUT_ATTACHMENTPOINT_IDX   = 122,
    SBK_QT3DRENDER_QRENDERTARGETSELECTOR_IDX                 = 123,
    SBK_QT3DRENDER_QSCENELOADER_IDX                          = 124,
    SBK_QT3DRENDER_QSCENELOADER_STATUS_IDX                   = 126,
    SBK_QT3DRENDER_QSCENELOADER_COMPONENTTYPE_IDX            = 125,
    SBK_QT3DRENDER_QSCISSORTEST_IDX                          = 127,
    SBK_QT3DRENDER_QSCREENRAYCASTER_IDX                      = 128,
    SBK_QT3DRENDER_QSEAMLESSCUBEMAP_IDX                      = 129,
    SBK_QT3DRENDER_QSETFENCE_IDX                             = 130,
    SBK_QT3DRENDER_QSETFENCE_HANDLETYPE_IDX                  = 131,
    SBK_QT3DRENDER_QSHADERDATA_IDX                           = 132,
    SBK_QT3DRENDER_QSHADERIMAGE_IDX                          = 133,
    SBK_QT3DRENDER_QSHADERIMAGE_ACCESS_IDX                   = 134,
    SBK_QT3DRENDER_QSHADERIMAGE_IMAGEFORMAT_IDX              = 135,
    SBK_QT3DRENDER_QSHADERPROGRAM_IDX                        = 136,
    ...
    SBK_QT3DRENDER_QTEXTUREGENERATOR_IDX                     = 166,

...
// Converter indices
enum : int {
    SBK_QTSVG_QLIST_QGRAPHICSITEMPTR_IDX                     = 0, // QList<QGraphicsItem* >
    SBK_QTSVG_QLIST_QGRAPHICSTRANSFORMPTR_IDX                = 1, // const QList<QGraphicsTransform* > &
    SBK_QTSVG_QLIST_QOBJECTPTR_IDX                           = 2, // const QList<QObject* > &
    SBK_QTSVG_QLIST_QBYTEARRAY_IDX                           = 3, // QList<QByteArray >
    SBK_QTSVG_QLIST_QACTIONPTR_IDX                           = 4, // QList<QAction* >
    SBK_QTSVG_QLIST_QVARIANT_IDX                             = 5, // QList<QVariant >
    SBK_QTSVG_QLIST_QSTRING_IDX                              = 6, // QList<QString >
    SBK_QTSVG_QMAP_QSTRING_QVARIANT_IDX                      = 7, // QMap<QString,QVariant >

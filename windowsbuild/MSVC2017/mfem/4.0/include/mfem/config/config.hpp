...
#define MFEM_VERSION 40000

// MFEM version string of the form "3.3" or "3.3.1".
#define MFEM_VERSION_STRING "4.0"
...
#define MFEM_SOURCE_DIR "C:/A_Visit/ThirdParty/mfem-4.0"

// MFEM install directory.
#define MFEM_INSTALL_DIR "C:/A_Visit/3.1RC/visit-deps/windowsbuild/MSVC2017/mfem/4.0"

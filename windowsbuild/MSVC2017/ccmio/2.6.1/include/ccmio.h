...
#if defined (_WIN32)
  #if defined(CCMIO_DLL)
    #define CCMIO_API __declspec(dllexport)
  #else
    #define CCMIO_API __declspec(dllimport)
  #endif
#else
  #define CCMIO_API extern
#endif
...
CCMIO_API CCMIOError CCMIOOpenFile( CCMIOError *err, char const *file,
...
CCMIO_API CCMIOError CCMIOCloseFile( CCMIOError *err, CCMIOID root );

/** Returns the version number of the file. */
CCMIO_API CCMIOError CCMIOGetVersion( CCMIOError *err, CCMIONode root,
				   int *version );

/** Sets the version number of the file. */
CCMIO_API CCMIOError CCMIOSetVersion( CCMIOError *err, CCMIONode root,
				   int version );
...
CCMIO_API CCMIOError CCMIOGetTitle( CCMIOError *err, CCMIONode root, char **title );

/** Sets the title of the file.  The string must be null-terminated. */
CCMIO_API CCMIOError CCMIOSetTitle( CCMIOError *err, CCMIONode root,
				 char const *title );
...
CCMIO_API CCMIOError CCMIOWriteOpti( CCMIOError *err, CCMIOID parent,
...
/** Creates a child node of parent with given name and scalar value.
    ...
    \param name		Name of the child node.
    \param value	Scalar value to be written. */
CCMIO_API CCMIOError CCMIOWriteOptf( CCMIOError *err, CCMIOID parent,
...
/** Creates a child node of parent with given name and scalar value.
    ...
    \param name		Name of the child node.
    \param value	Scalar value to be written. */
CCMIO_API CCMIOError CCMIOWriteOptd( CCMIOError *err, CCMIOID parent,
...
CCMIO_API CCMIOError CCMIOWriteOptstr( CCMIOError *err, CCMIOID parent,
...
CCMIO_API CCMIOError CCMIOReadOpti( CCMIOError *err, CCMIOID parent,
				 char const *name, int *value );
...
/** Reads the scalar value of a child node;  converts to an float
    ...
    \param name		Name of the child node.
    \param value	Pointer to the scalar data to be read in. */
CCMIO_API CCMIOError CCMIOReadOptf( CCMIOError *err, CCMIOID parent,
				 char const *name, float *value );
...
/** Reads the scalar value of a child node;  converts to an double
    ...
    \param name		Name of the child node.
    \param value	Pointer to the scalar data to be read in. */
CCMIO_API CCMIOError CCMIOReadOptd( CCMIOError *err, CCMIOID parent,
				 char const *name, double *value );
...
CCMIO_API CCMIOError CCMIOReadOptstr( CCMIOError *err, CCMIOID parent,
...
/** Reads a one-dimensional array from the child node of 'parent'
    ...
    description. */
CCMIO_API CCMIOError CCMIOReadOpt1i( CCMIOError *err, CCMIOID parent,
...
CCMIO_API CCMIOError CCMIOReadOpt1f( CCMIOError *err, CCMIOID parent,
				  char const *name, float *data,
				  CCMIOIndex start, CCMIOIndex end );
/** Reads a one-dimensional array from the child node of 'parent'
    with name 'name' into 'data'.  See CCMIOReadOpt1f() for a complete
    description. */
CCMIO_API CCMIOError CCMIOReadOpt1d( CCMIOError *err, CCMIOID parent,
...
/** Reads a two-dimensional array from the child node of 'parent'
    ...
    description. */
CCMIO_API CCMIOError CCMIOReadOpt2i( CCMIOError *err, CCMIOID parent,
				  char const *name, int *data,
				  CCMIOIndex start, CCMIOIndex end );
/** Reads a two-dimensional array from the child node of 'parent'
    with name 'name' into 'data'.  'data' must be the proper size
    ...
    \param end		The element one beyond the end.  So to read from [2, 5],
			...
			to data[5][3]. */
CCMIO_API CCMIOError CCMIOReadOpt2f( CCMIOError *err, CCMIOID parent,
				  char const *name, float *data,
				  CCMIOIndex start, CCMIOIndex end );
/** Reads a two-dimensional array from the child node of 'parent'
    with name 'name' into 'data'.  See CCMIOReadOpt2f() for a complete
    description. */
CCMIO_API CCMIOError CCMIOReadOpt2d( CCMIOError *err, CCMIOID parent,
				  char const *name, double *data,
				  CCMIOIndex start, CCMIOIndex end );
/** Reads a three-dimensional array from the child node of 'parent'
    with name 'name' into 'data'.  See CCMIOReadOpt3f() for a complete
    description. */
CCMIO_API CCMIOError CCMIOReadOpt3i( CCMIOError *err, CCMIOID parent,
				  char const *name, int *data,
				  CCMIOIndex start, CCMIOIndex end );
/** Reads a three-dimensional array from the child node of 'parent'
    with name 'name' into 'data'.  'data' must be the proper size
    ...
    \param end		The element one beyond the end.  So to read from [2, 5],
			...
			to data[5][3][3]. */
CCMIO_API CCMIOError CCMIOReadOpt3f( CCMIOError *err, CCMIOID parent,
				  char const *name, float *data,
				  CCMIOIndex start, CCMIOIndex end );
/** Reads a three-dimensional array from the child node of 'parent'
    with name 'name' into 'data'.  See CCMIOReadOpt3f() for a complete
    description. */
CCMIO_API CCMIOError CCMIOReadOpt3d( CCMIOError *err, CCMIOID parent,
				  char const *name, double *data,
				  CCMIOIndex start, CCMIOIndex end );

/** Writes a one-dimensional array to a child node of 'parent' with name 'name'.
    See CCMIOWriteOpt1f() for a complete description. */
CCMIO_API CCMIOError CCMIOWriteOpt1i( CCMIOError *err, CCMIOID const parent,
...
CCMIO_API CCMIOError CCMIOWriteOpt1f( CCMIOError *err, CCMIOID parent,
				   char const *name, CCMIOSize n,
				   float const *data,
				   CCMIOIndex start, CCMIOIndex end );
/** Writes a one-dimensional array to a child node of 'parent' with name 'name'.
    See CCMIOWriteOpt1f() for a complete description. */
CCMIO_API CCMIOError CCMIOWriteOpt1d( CCMIOError *err, CCMIOID parent,
				   char const *name, CCMIOSize n,
				   double const *data,
				   CCMIOIndex start, CCMIOIndex end );
/** Writes a two-dimensional array to a child node of 'parent' with name 'name'.
    See CCMIOWriteOpt2f() for a complete description. */
CCMIO_API CCMIOError CCMIOWriteOpt2i( CCMIOError *err, CCMIOID const parent,
...
/** Writes a two-dimensional array to a child node of 'parent' with name 'name'.
   ...
   <b>Note</b>: When writing partial arrays, the first block of the array you
   write <i>must</i> have start equal to kCCMIOStart. */
CCMIO_API CCMIOError CCMIOWriteOpt2f( CCMIOError *err, CCMIOID parent,
				   char const *name, CCMIOIndex x, CCMIOIndex y,
				   float const *data,
				   CCMIOIndex start, CCMIOIndex end );
/** Writes a two-dimensional array to a child node of 'parent' with name 'name'.
    See CCMIOWriteOpt2f() for a complete description. */
CCMIO_API CCMIOError CCMIOWriteOpt2d( CCMIOError *err, CCMIOID parent,
				   char const *name, CCMIOIndex x, CCMIOIndex y,
				   double const *data,
				   CCMIOIndex start, CCMIOIndex end );
/** Writes a three-dimensional array to a child node of 'parent' with name
    'name'.  See CCMIOWriteOpt3f() for a complete description. */
CCMIO_API CCMIOError CCMIOWriteOpt3i( CCMIOError *err, CCMIOID parent,
				   char const *name,
...
/** Writes a three-dimensional array to a child node of 'parent' with name
   ...
   <b>Note</b>: When writing partial arrays, the first block of the array you
   write <i>must</i> have start equal to kCCMIOStart. */
CCMIO_API CCMIOError CCMIOWriteOpt3f( CCMIOError *err, CCMIOID parent,
				   char const *name,
				   CCMIOIndex x, CCMIOIndex y, CCMIOIndex z,
...
/** Writes a three-dimensional array to a child node of 'parent' with name
    'name'.  See CCMIOWriteOpt3f() for a complete description. */
CCMIO_API CCMIOError CCMIOWriteOpt3d( CCMIOError *err, CCMIOID parent,
				   char const *name,
				   CCMIOIndex x, CCMIOIndex y, CCMIOIndex z,
...
CCMIO_API CCMIOError CCMIOGetOptInfo( CCMIOError *err, CCMIOID parent,
...
CCMIO_API void CCMIOInvalidateEntity( CCMIOID *entity );
...
CCMIO_API int CCMIOIsValidEntity( CCMIOID entity );

/** Returns TRUE if the two entities are from the same file,
    FALSE otherwise. */
CCMIO_API int CCMIOIsFromSameFile( CCMIOID entity1, CCMIOID entity2 );
...
CCMIO_API CCMIOError CCMIONewEntity( CCMIOError *err, CCMIOID parent,
...
/** Retrieves an entity.  Although it is mostly an internal function, it is
    ...
    \param id		The CCMIOID of the created entity. */
CCMIO_API CCMIOError CCMIOGetEntity( CCMIOError *err, CCMIOID parent,
...
CCMIO_API CCMIOError CCMIONewIndexedEntity( CCMIOError *err, CCMIOID parent,
...
CCMIO_API CCMIOError CCMIOGetEntityIndex( CCMIOError *err, CCMIOID id , int *n );
...
CCMIO_API CCMIOError CCMIONewState( CCMIOError *err, CCMIOID root,
...
CCMIO_API CCMIOError CCMIOGetState( CCMIOError *err, CCMIOID root,
				 char const *name, CCMIOID *problemDescription,
				 CCMIOID *state );
...
CCMIO_API CCMIOError CCMIOWriteState( CCMIOError *err, CCMIOID state,
...
CCMIO_API CCMIOError CCMIONewField( CCMIOError *err, CCMIOID phase,
...
CCMIO_API CCMIOError CCMIOGetField( CCMIOError *err, CCMIOID phase,
...
CCMIO_API CCMIOError CCMIOReadField( CCMIOError *err, CCMIOID field, char *name,
...
/** Creates a new prostar set.  The sets can be written with CCMIOWriteOpti().
    ...
    \param setID	The CCMIOID of the new prostar set.  Can be NULL if
			not desired. */
CCMIO_API CCMIOError CCMIONewProstarSet( CCMIOError *err, CCMIOID root, const char *name,
...
/** Gets a prostar set.
    ...
    \parma setID	The CCMIOID of the prostar set.  Can be NULL if not
			desired. */
CCMIO_API CCMIOError CCMIOGetProstarSet( CCMIOError *err, CCMIOID root, const char *name,
...
CCMIO_API CCMIOError CCMIODeleteEntity( CCMIOError *err, CCMIOID id );
...
CCMIO_API CCMIOError CCMIONextEntity( CCMIOError *err, CCMIOID parent,
...
/** Returns the number of elements and the maximum element ID in the specified
    ...
    desired. */
CCMIO_API CCMIOError CCMIOEntitySize( CCMIOError *err, CCMIOID id, CCMIOSize *n,
				   CCMIOIndex *max );
...
CCMIO_API CCMIOError CCMIOEntityName( CCMIOError *err, CCMIOID id, char *name );
...
CCMIO_API CCMIOError CCMIOEntityLabel( CCMIOError *err, CCMIOID id,
...
CCMIO_API CCMIOError CCMIOEntityDescription( CCMIOError *err, CCMIOID id,
					  CCMIOSize *size, char *desc );

/** Returns the CCMIO node corresponding to this entity. */
CCMIO_API CCMIOError CCMIOGetEntityNode( CCMIOError *err, CCMIOID id,
				      CCMIONode *node );

/** Returns the data type of the main data of the entity.  Currently only
    valid for vertices. */
CCMIO_API CCMIOError CCMIOEntityDataType( CCMIOError *err, CCMIOID id,
				       CCMIODataType *type );
...
/** Writes the map data.
   ...
   <b>Note</b>: When writing partial arrays, the first block of the array you
   write <i>must</i> have start equal to kCCMIOStart. */
CCMIO_API CCMIOError CCMIOWriteMap( CCMIOError *err, CCMIOID id,
...
CCMIO_API CCMIOError CCMIOReadMap( CCMIOError *err, CCMIOID id, int *data,
				CCMIOIndex start, CCMIOIndex end );
...
CCMIO_API CCMIOError CCMIOReadVerticesf( CCMIOError *err, CCMIOID id,
...
CCMIO_API CCMIOError CCMIOReadVerticesd( CCMIOError *err, CCMIOID id,
				      int *dims, float *scale,
...
CCMIO_API CCMIOError CCMIOWriteVerticesf( CCMIOError *err, CCMIOID id,
				       int dims, float scale,
...
/** Writes the vertex data.
   ...
   <b>Note</b>: When writing partial arrays, the first block of the array you
   write <i>must</i> have start equal to zero. */
CCMIO_API CCMIOError CCMIOWriteVerticesd( CCMIOError *err, CCMIOID id,
				       int dims, float scale,
...
/** Reads the cell data.
    ...
    \param end		The ending cell.  Data from 'start' to 'end' -1 will
			...
			to the end of the data. */
CCMIO_API CCMIOError CCMIOReadCells( CCMIOError *err, CCMIOID id, CCMIOID *mapID,
...
/** Writes the cell data
   ...
   <b>Note</b>: When writing partial arrays, the first block of the array you
   write <i>must</i> have start equal to kCCMIOStart. */
CCMIO_API CCMIOError CCMIOWriteCells( CCMIOError *err, CCMIOID id, CCMIOID mapID,
				   int *cellTypes, CCMIOIndex start,
                                   CCMIOIndex end );
...
CCMIO_API CCMIOError CCMIOReadFaces( CCMIOError *err, CCMIOID entity,
...
/** Writes the face data.  See CCMIOReadFaces() for a description of the
    ...
    <b>Note</b>: When writing partial arrays, the first block of the array you
    write <i>must</i> have start equal to zero. */
CCMIO_API CCMIOError CCMIOWriteFaces( CCMIOError *err, CCMIOID entity,
                                   CCMIOEntity which, CCMIOID mapID,
...
/** Reads the faces' cell associations with the faces.
   ...
   <b>Note</b>: When writing partial arrays, the first block of the array you
   write <i>must</i> have start equal to kCCMIOStart. */
CCMIO_API CCMIOError CCMIOReadFaceCells( CCMIOError *err, CCMIOID entity,
...
/** Writes the face data.  See CCMIOReadFaces() for a description of the
   ...
   <b>Note</b>: When writing partial arrays, the first block of the array you
   write <i>must</i> have start equal to zero. */
CCMIO_API CCMIOError CCMIOWriteFaceCells( CCMIOError *err, CCMIOID entity,
				CCMIOEntity which, CCMIOID mapID,
...
*/
CCMIO_API CCMIOError CCMIOWriteProcessor( CCMIOError *err, CCMIOID processor,
...
/** Reads the processor information.  The returned entities may be in a 
    ...
    is not desired. */
CCMIO_API CCMIOError CCMIOReadProcessor( CCMIOError *err, CCMIOID processor,
...
/** Clears the relevant information from the processor.  If this information
    ...
    \param clearLagrangian	If TRUE, any Lagrangian data will be cleared.
				If FALSE, it will be untouched. */
CCMIO_API CCMIOError CCMIOClearProcessor( CCMIOError *err, CCMIOID state,
				       CCMIOID processor,
...
CCMIO_API CCMIOError CCMIOWriteLagrangianData( CCMIOError *err, CCMIOID lagrangian,
...
/** Reads the Langrangian information.  The returned entities may be in a 
    ...
    until the end.  'positions' and 'solution' may be NULL if the information
    is not desired. */
CCMIO_API CCMIOError CCMIOReadLagrangianData( CCMIOError *err, CCMIOID lagrangian,
					   CCMIOID *positions,
					   CCMIOID *solution );
...
CCMIO_API CCMIOError CCMIOWriteMultiDimensionalFieldData( CCMIOError *err,
						       CCMIOID fieldID,
...
/** Gets the field ID of one component of a vector or tensor data field.
    ...
    \param componentField	The component field ID. */
CCMIO_API CCMIOError CCMIOReadMultiDimensionalFieldData( CCMIOError *err,
						      CCMIOID fieldID,
						      CCMIOComponent component,
						      CCMIOID *componentField );
...
/** Writes scalar data for a field.  Vector or tensor data should be written
   ...
   <b>Note</b>: When writing partial arrays, the first block of the array you
   write <i>must</i> have start equal to kCCMIOStart. */
CCMIO_API CCMIOError CCMIOWriteFieldDataf( CCMIOError *err, CCMIOID fieldData,
...
/** Writes the data for a field.  See CCMIOWriteFieldDataf() for a description
    of the paramaters. */
CCMIO_API CCMIOError CCMIOWriteFieldDatad( CCMIOError *err, CCMIOID fieldData,
					CCMIOID mapID, CCMIODataLocation loc,
...
/** Writes the data for a field.  See CCMIOWriteFieldDataf() for a description
    of the paramaters. */
CCMIO_API CCMIOError CCMIOWriteFieldDatai( CCMIOError *err, CCMIOID fieldData,
					CCMIOID mapID, CCMIODataLocation loc,
...
CCMIO_API CCMIOError CCMIOWriteConstantFieldDataf( CCMIOError *err,
						CCMIOID fieldData,
						CCMIOID mapID,
...
CCMIO_API CCMIOError CCMIOWriteConstantFieldDatad( CCMIOError *err,
						CCMIOID fieldData,
						CCMIOID mapID,
						CCMIODataLocation loc,
						double value );
...
/** Writes data for a field that is constant.  See
    CCMIOWriteConstantFieldDataf() for a description of the parameters. */
CCMIO_API CCMIOError CCMIOWriteConstantFieldDatai( CCMIOError *err,
						CCMIOID fieldData,
						CCMIOID mapID,
						CCMIODataLocation loc,
						int value );
...
/** Reads scalar data from a field.  The data is returned in single-precision
    ...
    \param end		The element one beyond the end.  So to read from [2, 5],
			...
			have scalar data)*/
CCMIO_API CCMIOError CCMIOReadFieldDataf( CCMIOError *err, CCMIOID fieldData,
				       CCMIOID *mapID, CCMIODataLocation *loc,
				       float *data, CCMIOIndex start,
				       CCMIOIndex end  );
...
CCMIO_API CCMIOError CCMIOReadFieldDatad( CCMIOError *err, CCMIOID fieldData,
				       CCMIOID *mapID, CCMIODataLocation *loc,
				       double *data, CCMIOIndex start,
				       CCMIOIndex end  );
...
/** Reads the data from a field.  The data is returned in double-precision
    so if the original data is single-precision it will be converted.
    See CCMIOReadFieldDataf() for a full description. */
CCMIO_API CCMIOError CCMIOReadFieldDatai( CCMIOError *err, CCMIOID fieldData,
				       CCMIOID *mapID, CCMIODataLocation *loc,
				       int *data, CCMIOIndex start,
				       CCMIOIndex end  );
...
CCMIO_API CCMIOError CCMIOWriteRestartInfo( CCMIOError *err, CCMIOID restartInfo,
...
/** Reads the solver restart entity.  Any pointer may be NULL if the
    information is not desired. */
CCMIO_API CCMIOError CCMIOReadRestartInfo( CCMIOError *err, CCMIOID restartInfo,
  ...
  /** \internal
     ...
     <b>Note</b>: When writing partial arrays, the first block of the array you
     write <i>must</i> have start equal to zero. */
CCMIO_API CCMIOError CCMIOV2WriteFaceCells(

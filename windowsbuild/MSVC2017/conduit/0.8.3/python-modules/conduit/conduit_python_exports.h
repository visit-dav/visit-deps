...
#define CONDUIT_WINDOWS_DLL_EXPORTS "TRUE"
    ...
    defined(CONDUIT_UTILS_PYTHON_EXPORTS) || \
    defined(conduit_utils_python_EXPORTS)
    ...
    #endif
#else
    #if __GNUC__ >= 4 && defined(CONDUIT_PYTHON_EXPORTS_DEFINED)

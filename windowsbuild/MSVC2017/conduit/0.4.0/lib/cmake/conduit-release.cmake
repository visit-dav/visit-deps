...
set_target_properties(conduit PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/conduit.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS conduit )
list(APPEND _IMPORT_CHECK_FILES_FOR_conduit "${_IMPORT_PREFIX}/lib/conduit.lib" "${_IMPORT_PREFIX}/lib/conduit.dll" )
...
set_target_properties(conduit_relay PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/conduit_relay.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS conduit_relay )
list(APPEND _IMPORT_CHECK_FILES_FOR_conduit_relay "${_IMPORT_PREFIX}/lib/conduit_relay.lib" "${_IMPORT_PREFIX}/lib/conduit_relay.dll" )
...
set_target_properties(conduit_relay_mpi PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/conduit_relay_mpi.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS conduit_relay_mpi )
list(APPEND _IMPORT_CHECK_FILES_FOR_conduit_relay_mpi "${_IMPORT_PREFIX}/lib/conduit_relay_mpi.lib" "${_IMPORT_PREFIX}/lib/conduit_relay_mpi.dll" )
...
set_target_properties(conduit_relay_mpi_io PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/conduit_relay_mpi_io.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS conduit_relay_mpi_io )
list(APPEND _IMPORT_CHECK_FILES_FOR_conduit_relay_mpi_io "${_IMPORT_PREFIX}/lib/conduit_relay_mpi_io.lib" "${_IMPORT_PREFIX}/lib/conduit_relay_mpi_io.dll" )
...
set_target_properties(conduit_blueprint PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/conduit_blueprint.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS conduit_blueprint )
list(APPEND _IMPORT_CHECK_FILES_FOR_conduit_blueprint "${_IMPORT_PREFIX}/lib/conduit_blueprint.lib" "${_IMPORT_PREFIX}/lib/conduit_blueprint.dll" )

...
foreach(_expectedTarget adios2::adios2sys adios2::adios2sys_private adios2::pugixml adios2::nlohmann_json adios2::adios2_mpi adios2::taustubs)
...
# Create imported target adios2::pugixml
add_library(adios2::pugixml INTERFACE IMPORTED)

# Create imported target adios2::nlohmann_json
add_library(adios2::nlohmann_json INTERFACE IMPORTED)

# Create imported target adios2::adios2_mpi
add_library(adios2::adios2_mpi SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/adios2-targets-*.cmake")

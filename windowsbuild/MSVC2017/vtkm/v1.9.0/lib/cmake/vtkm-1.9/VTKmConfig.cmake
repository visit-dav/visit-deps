...
set(VTKm_VERSION_MINOR "9")
set(VTKm_VERSION_PATCH "0")
set(VTKm_VERSION_FULL "1.9.0")
set(VTKm_VERSION "1.9")
...
if(CMAKE_CURRENT_LIST_DIR STREQUAL "C:/A_VisIt/ThirdParty/vtk-m-v1.9.0-build2/lib/cmake/vtkm-1.9")
  set(VTKm_PACKAGE_IN_BUILD TRUE)
endif()

if(VTKm_PACKAGE_IN_BUILD)
  set_and_check(VTKm_CMAKE_MODULE_PATH "C:/A_VisIt/ThirdParty/vtk-m-v1.9.0/CMake")
else()
  set_and_check(VTKm_CMAKE_MODULE_PATH "${PACKAGE_PREFIX_DIR}/share/vtkm-1.9/cmake")
endif()
...
if(NOT "${CMAKE_BINARY_DIR}" STREQUAL "C:/A_VisIt/ThirdParty/vtk-m-v1.9.0-build2")

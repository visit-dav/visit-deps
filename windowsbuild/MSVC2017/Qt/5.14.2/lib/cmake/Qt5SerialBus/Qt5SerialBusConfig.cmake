...
set(Qt5SerialBus_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::SerialBus)
    ...
    set(Qt5SerialBus_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialBus_install_prefix}/include/QtSerialBus/5.14.2"
        "${_qt5SerialBus_install_prefix}/include/QtSerialBus/5.14.2/QtSerialBus"
    )
    ...
    foreach(_module_dep ${_Qt5SerialBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5SerialBus_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::SerialBus PROPERTY INTERFACE_QT_ENABLED_FEATURES )
    set_property(TARGET Qt5::SerialBus PROPERTY INTERFACE_QT_DISABLED_FEATURES modbus-serialport)
    ...
    _populate_SerialBus_target_properties(RELEASE "Qt5SerialBus.dll" "Qt5SerialBus.lib" FALSE)

    if (EXISTS
        "${_qt5SerialBus_install_prefix}/bin/Qt5SerialBusd.dll"
      AND EXISTS
        "${_qt5SerialBus_install_prefix}/lib/Qt5SerialBusd.lib" )
        _populate_SerialBus_target_properties(DEBUG "Qt5SerialBusd.dll" "Qt5SerialBusd.lib" FALSE)
    endif()

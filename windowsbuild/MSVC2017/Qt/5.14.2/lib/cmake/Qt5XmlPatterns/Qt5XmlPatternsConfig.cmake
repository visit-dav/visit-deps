...
if (NOT TARGET Qt5::XmlPatterns)
    ...
    _populate_XmlPatterns_target_properties(RELEASE "Qt5XmlPatterns.dll" "Qt5XmlPatterns.lib" FALSE)

    if (EXISTS
        "${_qt5XmlPatterns_install_prefix}/bin/Qt5XmlPatternsd.dll"
      AND EXISTS
        "${_qt5XmlPatterns_install_prefix}/lib/Qt5XmlPatternsd.lib" )
        _populate_XmlPatterns_target_properties(DEBUG "Qt5XmlPatternsd.dll" "Qt5XmlPatternsd.lib" FALSE)
    endif()

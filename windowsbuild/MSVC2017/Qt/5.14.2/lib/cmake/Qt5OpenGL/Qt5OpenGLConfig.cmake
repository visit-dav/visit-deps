...
set(Qt5OpenGL_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::OpenGL)
    ...
    set(Qt5OpenGL_PRIVATE_INCLUDE_DIRS
        "${_qt5OpenGL_install_prefix}/include/QtOpenGL/5.14.2"
        "${_qt5OpenGL_install_prefix}/include/QtOpenGL/5.14.2/QtOpenGL"
    )
    ...
    foreach(_module_dep ${_Qt5OpenGL_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5OpenGL_FIND_VERSION_EXACT}
    ...
    _populate_OpenGL_target_properties(RELEASE "Qt5OpenGL.dll" "Qt5OpenGL.lib" FALSE)

    if (EXISTS
        "${_qt5OpenGL_install_prefix}/bin/Qt5OpenGLd.dll"
      AND EXISTS
        "${_qt5OpenGL_install_prefix}/lib/Qt5OpenGLd.lib" )
        _populate_OpenGL_target_properties(DEBUG "Qt5OpenGLd.dll" "Qt5OpenGLd.lib" FALSE)
    endif()

...
set(Qt5QmlWorkerScript_VERSION_STRING 5.14.2)
...
macro(_populate_QmlWorkerScript_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5QmlWorkerScript_install_prefix}/bin/${LIB_LOCATION}")
    ...
    set(imported_implib "${_qt5QmlWorkerScript_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_QmlWorkerScript_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::QmlWorkerScript)
    ...
    set(Qt5QmlWorkerScript_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlWorkerScript_install_prefix}/include/QtQmlWorkerScript/5.14.2"
        "${_qt5QmlWorkerScript_install_prefix}/include/QtQmlWorkerScript/5.14.2/QtQmlWorkerScript"
    )
    ...
    foreach(_module_dep ${_Qt5QmlWorkerScript_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5QmlWorkerScript_FIND_VERSION_EXACT}
    ...
    _populate_QmlWorkerScript_target_properties(RELEASE "Qt5QmlWorkerScript.dll" "Qt5QmlWorkerScript.lib" FALSE)

    if (EXISTS
        "${_qt5QmlWorkerScript_install_prefix}/bin/Qt5QmlWorkerScriptd.dll"
      AND EXISTS
        "${_qt5QmlWorkerScript_install_prefix}/lib/Qt5QmlWorkerScriptd.lib" )
        _populate_QmlWorkerScript_target_properties(DEBUG "Qt5QmlWorkerScriptd.dll" "Qt5QmlWorkerScriptd.lib" FALSE)
    endif()

...
macro(_populate_QuickShapes_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5QuickShapes_install_prefix}/bin/${LIB_LOCATION}")
    ...
    set(imported_implib "${_qt5QuickShapes_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_QuickShapes_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::QuickShapes)
    ...
    _populate_QuickShapes_target_properties(RELEASE "Qt5QuickShapes.dll" "Qt5QuickShapes.lib" FALSE)

    if (EXISTS
        "${_qt5QuickShapes_install_prefix}/bin/Qt5QuickShapesd.dll"
      AND EXISTS
        "${_qt5QuickShapes_install_prefix}/lib/Qt5QuickShapesd.lib" )
        _populate_QuickShapes_target_properties(DEBUG "Qt5QuickShapesd.dll" "Qt5QuickShapesd.lib" FALSE)
    endif()

...
set(Qt5QmlDevTools_VERSION_STRING 5.14.2)
...
function(_qt5_QmlDevTools_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    set(_qt5_install_libs "${_qt5QmlDevTools_install_prefix}/lib/")
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(current_search_paths)
                        find_library(_Qt5QmlDevTools_${Configuration}_${_lib}_PATH ${_lib} HINTS ${current_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt5QmlDevTools_${Configuration}_${_lib}_PATH ${_lib} HINTS ${CMAKE_CXX_IMPLICIT_LINK_DIRECTORIES})
...
macro(_populate_QmlDevTools_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_implib "${_qt5QmlDevTools_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_QmlDevTools_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::QmlDevTools)
    ...
    set(Qt5QmlDevTools_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlDevTools_install_prefix}/include/QtQml/5.14.2"
        "${_qt5QmlDevTools_install_prefix}/include/QtQml/5.14.2/QtQml"
    )
    ...
    foreach(_module_dep ${_Qt5QmlDevTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5QmlDevTools_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_QmlDevTools_process_prl_file(
            "${_qt5QmlDevTools_install_prefix}/lib/Qt5QmlDevTools.prl" RELEASE
    ...
    set_property(TARGET Qt5::QmlDevTools PROPERTY INTERFACE_QT_PLUGIN_TYPES "")
    ...
    _populate_QmlDevTools_target_properties(RELEASE "Qt5QmlDevTools.lib" "" FALSE)

    if (EXISTS "${_qt5QmlDevTools_install_prefix}/lib/Qt5QmlDevToolsd.lib" )
        _populate_QmlDevTools_target_properties(DEBUG "Qt5QmlDevToolsd.lib" "" FALSE)
    endif()

...
set(Qt5Help_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Help)
    ...
    set(Qt5Help_PRIVATE_INCLUDE_DIRS
        "${_qt5Help_install_prefix}/include/QtHelp/5.14.2"
        "${_qt5Help_install_prefix}/include/QtHelp/5.14.2/QtHelp"
    )
    ...
    foreach(_module_dep ${_Qt5Help_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Help_FIND_VERSION_EXACT}
    ...
    _populate_Help_target_properties(RELEASE "Qt5Help.dll" "Qt5Help.lib" FALSE)

    if (EXISTS
        "${_qt5Help_install_prefix}/bin/Qt5Helpd.dll"
      AND EXISTS
        "${_qt5Help_install_prefix}/lib/Qt5Helpd.lib" )
        _populate_Help_target_properties(DEBUG "Qt5Helpd.dll" "Qt5Helpd.lib" FALSE)
    endif()

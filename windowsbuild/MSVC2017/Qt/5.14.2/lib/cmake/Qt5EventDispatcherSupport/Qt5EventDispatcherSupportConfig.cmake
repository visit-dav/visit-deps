...
macro(_populate_EventDispatcherSupport_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_implib "${_qt5EventDispatcherSupport_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_EventDispatcherSupport_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::EventDispatcherSupport)
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_EventDispatcherSupport_process_prl_file(
            "${_qt5EventDispatcherSupport_install_prefix}/lib/Qt5EventDispatcherSupport.prl" RELEASE

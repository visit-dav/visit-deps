...
set(Qt5Svg_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Svg)
    ...
    set(Qt5Svg_PRIVATE_INCLUDE_DIRS
        "${_qt5Svg_install_prefix}/include/QtSvg/5.14.2"
        "${_qt5Svg_install_prefix}/include/QtSvg/5.14.2/QtSvg"
    )
    ...
    foreach(_module_dep ${_Qt5Svg_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Svg_FIND_VERSION_EXACT}
    ...
    _populate_Svg_target_properties(RELEASE "Qt5Svg.dll" "Qt5Svg.lib" FALSE)

    if (EXISTS
        "${_qt5Svg_install_prefix}/bin/Qt5Svgd.dll"
      AND EXISTS
        "${_qt5Svg_install_prefix}/lib/Qt5Svgd.lib" )
        _populate_Svg_target_properties(DEBUG "Qt5Svgd.dll" "Qt5Svgd.lib" FALSE)
    endif()

...
macro(_populate_Test_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set_property(TARGET Qt5::Test APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                 "${_deps}"
    )
...
if (NOT TARGET Qt5::Test)
    ...
    _populate_Test_target_properties(RELEASE "Qt5Test.dll" "Qt5Test.lib" FALSE)

    if (EXISTS
        "${_qt5Test_install_prefix}/bin/Qt5Testd.dll"
      AND EXISTS
        "${_qt5Test_install_prefix}/lib/Qt5Testd.lib" )
        _populate_Test_target_properties(DEBUG "Qt5Testd.dll" "Qt5Testd.lib" FALSE)
    endif()

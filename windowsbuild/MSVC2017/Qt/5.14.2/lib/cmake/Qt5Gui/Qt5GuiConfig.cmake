...
if (NOT TARGET Qt5::Gui)
    ...
    set_property(TARGET Qt5::Gui PROPERTY INTERFACE_QT_DISABLED_FEATURES angle;combined-angle-lib;opengles2;dynamicgl;opengles3;opengles31;opengles32;openvg;system-textmarkdownreader;vulkan)
    ...
    _populate_Gui_target_properties(RELEASE "Qt5Gui.dll" "Qt5Gui.lib" FALSE)

    if (EXISTS
        "${_qt5Gui_install_prefix}/bin/Qt5Guid.dll"
      AND EXISTS
        "${_qt5Gui_install_prefix}/lib/Qt5Guid.lib" )
        _populate_Gui_target_properties(DEBUG "Qt5Guid.dll" "Qt5Guid.lib" FALSE)
    endif()

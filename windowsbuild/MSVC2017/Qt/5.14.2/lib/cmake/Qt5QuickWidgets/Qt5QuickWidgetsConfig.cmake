...
if (NOT TARGET Qt5::QuickWidgets)
    ...
    _populate_QuickWidgets_target_properties(RELEASE "Qt5QuickWidgets.dll" "Qt5QuickWidgets.lib" FALSE)

    if (EXISTS
        "${_qt5QuickWidgets_install_prefix}/bin/Qt5QuickWidgetsd.dll"
      AND EXISTS
        "${_qt5QuickWidgets_install_prefix}/lib/Qt5QuickWidgetsd.lib" )
        _populate_QuickWidgets_target_properties(DEBUG "Qt5QuickWidgetsd.dll" "Qt5QuickWidgetsd.lib" FALSE)
    endif()

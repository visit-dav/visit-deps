...
set(Qt5WinExtras_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::WinExtras)
    ...
    set(Qt5WinExtras_PRIVATE_INCLUDE_DIRS
        "${_qt5WinExtras_install_prefix}/include/QtWinExtras/5.14.2"
        "${_qt5WinExtras_install_prefix}/include/QtWinExtras/5.14.2/QtWinExtras"
    )
    ...
    foreach(_module_dep ${_Qt5WinExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5WinExtras_FIND_VERSION_EXACT}
    ...
    _populate_WinExtras_target_properties(RELEASE "Qt5WinExtras.dll" "Qt5WinExtras.lib" FALSE)

    if (EXISTS
        "${_qt5WinExtras_install_prefix}/bin/Qt5WinExtrasd.dll"
      AND EXISTS
        "${_qt5WinExtras_install_prefix}/lib/Qt5WinExtrasd.lib" )
        _populate_WinExtras_target_properties(DEBUG "Qt5WinExtrasd.dll" "Qt5WinExtrasd.lib" FALSE)
    endif()

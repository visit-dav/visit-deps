...
macro(_populate_PlatformCompositorSupport_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_implib "${_qt5PlatformCompositorSupport_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_PlatformCompositorSupport_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::PlatformCompositorSupport)
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_PlatformCompositorSupport_process_prl_file(
            "${_qt5PlatformCompositorSupport_install_prefix}/lib/Qt5PlatformCompositorSupport.prl" RELEASE
    ...
    _populate_PlatformCompositorSupport_target_properties(RELEASE "Qt5PlatformCompositorSupport.lib" "" FALSE)

    if (EXISTS "${_qt5PlatformCompositorSupport_install_prefix}/lib/Qt5PlatformCompositorSupportd.lib" )
        _populate_PlatformCompositorSupport_target_properties(DEBUG "Qt5PlatformCompositorSupportd.lib" "" FALSE)
    endif()

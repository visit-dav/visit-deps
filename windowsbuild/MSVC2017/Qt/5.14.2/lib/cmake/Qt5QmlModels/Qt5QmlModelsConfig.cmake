...
set(Qt5QmlModels_VERSION_STRING 5.14.2)
...
macro(_populate_QmlModels_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5QmlModels_install_prefix}/bin/${LIB_LOCATION}")
    ...
    set(imported_implib "${_qt5QmlModels_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_QmlModels_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::QmlModels)
    ...
    set(_Qt5QmlModels_OWN_INCLUDE_DIRS "${_qt5QmlModels_install_prefix}/include/" "${_qt5QmlModels_install_prefix}/include/QtQmlModels")
    set(Qt5QmlModels_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlModels_install_prefix}/include/QtQmlModels/5.14.2"
        "${_qt5QmlModels_install_prefix}/include/QtQmlModels/5.14.2/QtQmlModels"
    )
    ...
    foreach(_module_dep ${_Qt5QmlModels_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5QmlModels_FIND_VERSION_EXACT}
    ...
    _populate_QmlModels_target_properties(RELEASE "Qt5QmlModels.dll" "Qt5QmlModels.lib" FALSE)

    if (EXISTS
        "${_qt5QmlModels_install_prefix}/bin/Qt5QmlModelsd.dll"
      AND EXISTS
        "${_qt5QmlModels_install_prefix}/lib/Qt5QmlModelsd.lib" )
        _populate_QmlModels_target_properties(DEBUG "Qt5QmlModelsd.dll" "Qt5QmlModelsd.lib" FALSE)
    endif()

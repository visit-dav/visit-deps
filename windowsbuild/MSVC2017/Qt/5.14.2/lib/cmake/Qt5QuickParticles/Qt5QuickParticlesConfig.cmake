...
macro(_populate_QuickParticles_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5QuickParticles_install_prefix}/bin/${LIB_LOCATION}")
    ...
    set(imported_implib "${_qt5QuickParticles_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_QuickParticles_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::QuickParticles)
    ...
    _populate_QuickParticles_target_properties(RELEASE "Qt5QuickParticles.dll" "Qt5QuickParticles.lib" FALSE)

    if (EXISTS
        "${_qt5QuickParticles_install_prefix}/bin/Qt5QuickParticlesd.dll"
      AND EXISTS
        "${_qt5QuickParticles_install_prefix}/lib/Qt5QuickParticlesd.lib" )
        _populate_QuickParticles_target_properties(DEBUG "Qt5QuickParticlesd.dll" "Qt5QuickParticlesd.lib" FALSE)
    endif()

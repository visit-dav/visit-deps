...
if (NOT TARGET Qt5::QuickTest)
    ...
    _populate_QuickTest_target_properties(RELEASE "Qt5QuickTest.dll" "Qt5QuickTest.lib" FALSE)

    if (EXISTS
        "${_qt5QuickTest_install_prefix}/bin/Qt5QuickTestd.dll"
      AND EXISTS
        "${_qt5QuickTest_install_prefix}/lib/Qt5QuickTestd.lib" )
        _populate_QuickTest_target_properties(DEBUG "Qt5QuickTestd.dll" "Qt5QuickTestd.lib" FALSE)
    endif()

...
if (NOT TARGET Qt5::Qml)
    ...
    set_property(TARGET Qt5::Qml PROPERTY INTERFACE_QT_ENABLED_FEATURES qml-network)
    set_property(TARGET Qt5::Qml PROPERTY INTERFACE_QT_DISABLED_FEATURES qml-debug)
    ...
    _populate_Qml_target_properties(RELEASE "Qt5Qml.dll" "Qt5Qml.lib" FALSE)

    if (EXISTS
        "${_qt5Qml_install_prefix}/bin/Qt5Qmld.dll"
      AND EXISTS
        "${_qt5Qml_install_prefix}/lib/Qt5Qmld.lib" )
        _populate_Qml_target_properties(DEBUG "Qt5Qmld.dll" "Qt5Qmld.lib" FALSE)
    endif()

...
set(Qt5Network_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Network)
    ...
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/include/QtNetwork/5.14.2"
        "${_qt5Network_install_prefix}/include/QtNetwork/5.14.2/QtNetwork"
    )
    ...
    foreach(_module_dep ${_Qt5Network_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Network_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_ENABLED_FEATURES networkinterface;bearermanagement;dnslookup;udpsocket;dtls;ftp;http;localserver;networkdiskcache;networkproxy;socks5;ssl;sspi)
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_DISABLED_FEATURES securetransport;schannel;gssapi;opensslv11;ocsp;sctp)
    ...
    _populate_Network_target_properties(RELEASE "Qt5Network.dll" "Qt5Network.lib" FALSE)

    if (EXISTS
        "${_qt5Network_install_prefix}/bin/Qt5Networkd.dll"
      AND EXISTS
        "${_qt5Network_install_prefix}/lib/Qt5Networkd.lib" )
        _populate_Network_target_properties(DEBUG "Qt5Networkd.dll" "Qt5Networkd.lib" FALSE)
    endif()

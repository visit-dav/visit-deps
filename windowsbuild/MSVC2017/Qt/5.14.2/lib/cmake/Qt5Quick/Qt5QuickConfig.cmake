...
if (NOT TARGET Qt5::Quick)
    ...
    set_property(TARGET Qt5::Quick PROPERTY INTERFACE_QT_ENABLED_FEATURES d3d12;quick-draganddrop)
    ...
    _populate_Quick_target_properties(RELEASE "Qt5Quick.dll" "Qt5Quick.lib" FALSE)

    if (EXISTS
        "${_qt5Quick_install_prefix}/bin/Qt5Quickd.dll"
      AND EXISTS
        "${_qt5Quick_install_prefix}/lib/Qt5Quickd.lib" )
        _populate_Quick_target_properties(DEBUG "Qt5Quickd.dll" "Qt5Quickd.lib" FALSE)
    endif()

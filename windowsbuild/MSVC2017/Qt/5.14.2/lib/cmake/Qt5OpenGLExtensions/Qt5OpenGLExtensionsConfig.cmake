...
function(_qt5_OpenGLExtensions_process_prl_file prl_file_location Configuration lib_deps link_flags)
    set(_lib_deps)
    set(_link_flags)

    set(_qt5_install_libs "${_qt5OpenGLExtensions_install_prefix}/lib/")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(_Qt5OpenGLExtensions_${Configuration}_${_lib}_PATH)
                        list(APPEND _lib_deps
                            ${_Qt5OpenGLExtensions_${Configuration}_${_lib}_PATH}
                        )
                    else()
...
macro(_populate_OpenGLExtensions_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(_deps
        ${_Qt5OpenGLExtensions_LIB_DEPENDENCIES}
    )
    set(_static_deps
        ${_Qt5OpenGLExtensions_STATIC_${Configuration}_LIB_DEPENDENCIES}
    )
    ...
    set_property(TARGET Qt5::OpenGLExtensions APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                 "${_deps}"
    )
    ...
    set(_static_link_flags "${_Qt5OpenGLExtensions_STATIC_${Configuration}_LINK_FLAGS}")
...
if (NOT TARGET Qt5::OpenGLExtensions)
    ...
    if(TARGET Qt5::OpenGLExtensions)
        return()
    endif()
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_OpenGLExtensions_process_prl_file(
            "${_qt5OpenGLExtensions_install_prefix}/lib/Qt5OpenGLExtensions.prl" RELEASE
            _Qt5OpenGLExtensions_STATIC_RELEASE_LIB_DEPENDENCIES
            _Qt5OpenGLExtensions_STATIC_RELEASE_LINK_FLAGS
        )
    endif()
    ...
    _populate_OpenGLExtensions_target_properties(RELEASE "Qt5OpenGLExtensions.lib" "" FALSE)

    if (EXISTS "${_qt5OpenGLExtensions_install_prefix}/lib/Qt5OpenGLExtensionsd.lib" )
        _populate_OpenGLExtensions_target_properties(DEBUG "Qt5OpenGLExtensionsd.lib" "" FALSE)
    endif()

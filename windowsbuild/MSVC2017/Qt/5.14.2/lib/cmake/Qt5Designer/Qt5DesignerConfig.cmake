...
set(Qt5Designer_VERSION_STRING 5.14.2)
...
if (NOT TARGET Qt5::Designer)
    ...
    set(Qt5Designer_PRIVATE_INCLUDE_DIRS
        "${_qt5Designer_install_prefix}/include/QtDesigner/5.14.2"
        "${_qt5Designer_install_prefix}/include/QtDesigner/5.14.2/QtDesigner"
    )
    ...
    foreach(_module_dep ${_Qt5Designer_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.2 ${_Qt5Designer_FIND_VERSION_EXACT}
    ...
    _populate_Designer_target_properties(RELEASE "Qt5Designer.dll" "Qt5Designer.lib" FALSE)

    if (EXISTS
        "${_qt5Designer_install_prefix}/bin/Qt5Designerd.dll"
      AND EXISTS
        "${_qt5Designer_install_prefix}/lib/Qt5Designerd.lib" )
        _populate_Designer_target_properties(DEBUG "Qt5Designerd.dll" "Qt5Designerd.lib" FALSE)
    endif()

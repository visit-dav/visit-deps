//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/geometry/Curves_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  Curves_create();
    extern void *  Curves_set(void * _self, struct RTCGeometryTy * geom, bool haveColor, bool haveTexture, int32_t numSegments);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

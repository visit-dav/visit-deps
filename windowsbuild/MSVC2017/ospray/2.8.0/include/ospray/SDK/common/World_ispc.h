//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/common/World_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  World_create();
    extern void World_destroy(void * _self);
    extern void World_set(void * _self, void * _geometriesInst, int32_t numGeometriesInst, void * _volumesInst, int32_t numVolumesInst, void * _clippersInst, int32_t numClippersInst, void * embreeGeometryScene, void * embreeVolumeScene, void * embreeClipScene, int32_t numInvertedClippers);
    extern void World_setPathtracerData(void * _self, void *  * lights, const uint32_t numLights, const uint32_t numGeoLights);
    extern void World_setSciVisData(void * _self, const struct vec3f &aoColor, void *  * lights, const uint32_t numLights, const uint32_t numLightsVisibleOnly);

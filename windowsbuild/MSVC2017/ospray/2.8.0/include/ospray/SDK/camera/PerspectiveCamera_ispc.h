//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/camera/PerspectiveCamera_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  PerspectiveCamera_create();
    extern void PerspectiveCamera_projectBox(void * _self, const struct box3f &box, struct box3f &projection);
    extern void PerspectiveCamera_set(void * _self, const struct vec3f &org, const struct vec3f &dir, const struct vec3f &up, const struct vec2f &imgPlaneSize, const float scaledAperture, const float focusDistance, const float aspect, const bool architectural, const int32_t stereoMode, const float ipd);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

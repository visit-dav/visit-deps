//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/camera/PanoramicCamera_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  PanoramicCamera_create();
    extern void PanoramicCamera_set(void * _self, const struct vec3f &org, const struct vec3f &dir, const struct vec3f &up, const int32_t stereoMode, const float ipd);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

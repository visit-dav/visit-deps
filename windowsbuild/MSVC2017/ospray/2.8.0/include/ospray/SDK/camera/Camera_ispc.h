//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/camera/Camera_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void Camera_set(void * _self, const float nearClip, const struct vec2f &imageStart, const struct vec2f &imageEnd, const struct box1f &shutter, const bool globalShutter, const float rollingShutterDuration, const bool rollingShutterHorizontal, const bool motionBlur, struct RTCGeometryTy * geom);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

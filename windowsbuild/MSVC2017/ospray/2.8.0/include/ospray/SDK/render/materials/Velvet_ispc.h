//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/render/materials/Velvet_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  PathTracer_Velvet_create();
    extern void *  PathTracer_Velvet_set(void * _self, const struct vec3f &reflectance, const struct vec3f &horizonScatteringColor, float horizonScatteringFallOff, float backScattering);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

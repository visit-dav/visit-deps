//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/render/materials/ThinGlass_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  PathTracer_ThinGlass_create();
    extern void PathTracer_ThinGlass_set(void * _self, const float ior, const struct vec3f &attenuationColor, const struct TextureParam &attenuationColorMap, const float attenuationDistance, const float thickness);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

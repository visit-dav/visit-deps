//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/render/materials/MetallicPaint_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  PathTracer_MetallicPaint_create();
    extern void *  PathTracer_MetallicPaint_set(void * _self, const struct vec3f &baseColor, const struct TextureParam &baseColorMap, const float flakeAmount, const struct vec3f &flakeColor, const float flakeSpread, const float ior);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

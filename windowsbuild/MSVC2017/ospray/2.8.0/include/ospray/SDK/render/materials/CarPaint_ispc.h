//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/render/materials/CarPaint_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  PathTracer_CarPaint_create();
    extern void *  PathTracer_CarPaint_set(void * _self, const struct vec3f &baseColor, const struct TextureParam &baseColorMap, float roughness, const struct TextureParam &roughnessMap, float normal, const struct TextureParam &normalMap, const struct LinearSpace2f &normalRot, const bool useFlakeColor, const struct vec3f &flakeColor, const struct TextureParam &flakeColorMap, float flakeScale, const struct TextureParam &flakeScaleMap, float flakeDensity, const struct TextureParam &flakeDensityMap, float flakeSpread, const struct TextureParam &flakeSpreadMap, float flakeJitter, const struct TextureParam &flakeJitterMap, float flakeRoughness, const struct TextureParam &flakeRoughnessMap, float coat, const struct TextureParam &coatMap, float coatIor, const struct TextureParam &coatIorMap, const struct vec3f &coatColor, const struct TextureParam &coatColorMap, float coatThickness, const struct TextureParam &coatThicknessMap, float coatRoughness, const struct TextureParam &coatRoughnessMap, float coatNormal, const struct TextureParam &coatNormalMap, const struct LinearSpace2f &coatNormalRot, const struct vec3f &flipflopColor, const struct TextureParam &flipflopColorMap, float flipflopFalloff, const struct TextureParam &flipflopFalloffMap);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

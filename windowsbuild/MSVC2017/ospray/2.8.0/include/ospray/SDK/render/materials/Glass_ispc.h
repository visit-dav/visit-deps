//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/render/materials/Glass_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  PathTracer_Glass_create();
    extern void PathTracer_Glass_set(void * _self, const float iorInside, const struct vec3f &attenuationColorInside, const float outsideIor, const struct vec3f &attenuationColorOutside, const float attenuationDistance);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

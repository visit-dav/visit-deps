//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/render/materials/Alloy_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  PathTracer_Alloy_create();
    extern void *  PathTracer_Alloy_set(void * _self, const struct vec3f &color, const struct TextureParam &colorMap, const struct vec3f &edgeColor, const struct TextureParam &edgeColorMap, float roughness, const struct TextureParam &roughnessMap);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/render/materials/Metal_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  PathTracer_Metal_create();
    extern void *  PathTracer_Metal_set(void * _self, const float * eta, const float * k, const struct vec3f &etaRGB, const struct vec3f &kRGB, float roughness, const struct TextureParam &roughnessMap);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/render/materials/Mix_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  PathTracer_Mix_create();
    extern void PathTracer_Mix_set(void * _self, float factor, const struct TextureParam &factorMap, void * _mat1, void * _mat2);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/render/materials/Plastic_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  PathTracer_Plastic_create();
    extern void *  PathTracer_Plastic_set(void * _self, const struct vec3f &pigmentColor, float ior, float roughness);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/render/debug/DebugRenderer_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  DebugRenderer_create();
    extern void DebugRenderer_set(void * _self, int32_t type);

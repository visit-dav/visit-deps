//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/render/materials/Principled_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  PathTracer_Principled_create();
    extern void *  PathTracer_Principled_set(void * _self, const struct vec3f &baseColor, const struct TextureParam &baseColorMap, const struct vec3f &edgeColor, const struct TextureParam &edgeColorMap, float metallic, const struct TextureParam &metallicMap, float diffuse, const struct TextureParam &diffuseMap, float specular, const struct TextureParam &specularMap, float ior, const struct TextureParam &iorMap, float transmission, const struct TextureParam &transmissionMap, const struct vec3f &transmissionColor, const struct TextureParam &transmissionColorMap, float transmissionDepth, const struct TextureParam &transmissionDepthMap, float roughness, const struct TextureParam &roughnessMap, float anisotropy, const struct TextureParam &anisotropyMap, float rotation, const struct TextureParam &rotationMap, float normal, const struct TextureParam &normalMap, const struct LinearSpace2f &normalRot, float baseNormal, const struct TextureParam &baseNormalMap, const struct LinearSpace2f &baseNormalRot, float coat, const struct TextureParam &coatMap, float coatIor, const struct TextureParam &coatIorMap, const struct vec3f &coatColor, const struct TextureParam &coatColorMap, float coatThickness, const struct TextureParam &coatThicknessMap, float coatRoughness, const struct TextureParam &coatRoughnessMap, float coatNormal, const struct TextureParam &coatNormalMap, const struct LinearSpace2f &coatNormalRot, float sheen, const struct TextureParam &sheenMap, const struct vec3f &sheenColor, const struct TextureParam &sheenColorMap, float sheenTint, const struct TextureParam &sheenTintMap, float sheenRoughness, const struct TextureParam &sheenRoughnessMap, float opacity, const struct TextureParam &opacityMap, bool thin, float backlight, const struct TextureParam &backlightMap, float thickness, const struct TextureParam &thicknessMap, float outsideIor, const struct vec3f &outsideTransmissionColor, float outsideTransmissionDepth);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

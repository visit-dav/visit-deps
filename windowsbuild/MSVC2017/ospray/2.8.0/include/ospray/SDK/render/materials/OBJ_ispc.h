//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/render/materials/OBJ_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  PathTracer_OBJ_create();
    extern void PathTracer_OBJ_set(void * _self, const struct TextureParam &dMap, const float d, const struct TextureParam &KdMap, const struct vec3f &Kd, const struct TextureParam &KsMap, const struct vec3f &Ks, const struct TextureParam &NsMap, const float Ns, const struct vec3f &Tf, const struct TextureParam &bumpMap, const struct LinearSpace2f &bumpRot);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

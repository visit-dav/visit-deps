//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/lights/SpotLight_ispc.h
...
extern "C" {
    ...
    extern void SpotLight_set(void * super, const struct vec3f &position, const struct vec3f &direction, const struct vec3f &c0, const struct vec3f &radiance, const struct vec3f &intensity, float cosAngleMax, float cosAngleScale, float radius, float innerRadius, const struct vec2i &size, float * lid);

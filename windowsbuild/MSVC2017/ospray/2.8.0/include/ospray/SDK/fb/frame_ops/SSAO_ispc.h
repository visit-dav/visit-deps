//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/fb/frame_ops/SSAO_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void LiveSSAOFrameOp_applyOcclusion(void * _self, void * _fb, void * _color, float * occlusionBuffer);
    extern void *  LiveSSAOFrameOp_create();
    extern void LiveSSAOFrameOp_getOcclusion(const void * _self, void * _fb, float * occlusionBuffer, const float radius, const float checkRadius, int32_t kernelSize, int32_t programID);

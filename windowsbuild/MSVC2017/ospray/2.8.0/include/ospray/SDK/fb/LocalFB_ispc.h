//
// C:/A_Visit/ThirdParty/ospray-2.8.0-build2/ospray/build/ospray/fb/LocalFB_ispc.h
...
#ifndef __ISPC_STRUCT_Tile__
#define __ISPC_STRUCT_Tile__
struct Tile {
    struct box2i region;
    struct vec2i fbSize;
...
extern "C" {
#endif // __cplusplus
    extern void LocalFrameBuffer_accumulateAuxTile(void * _fb, const struct Tile &tile, struct vec3f * aux, const void * _ax, const void * _ay, const void * _az);
    extern float LocalFrameBuffer_accumulateTile(void * _fb, struct Tile &tile);
    extern void LocalFrameBuffer_accumulateWriteDepthTile(void * _fb, const struct Tile &tile);
    extern void *  LocalFrameBuffer_create(const uint32_t size_x, const uint32_t size_y, int32_t colorBufferFormat, void * colorBuffer, void * depthBuffer, void * accumBuffer, void * varianceBuffer, void * normalBuffer, void * albedoBuffer, void * tileAccumID);
    extern void LocalFrameBuffer_writeTile_RGBA32F(void * _fb, struct Tile &tile);
    extern void LocalFrameBuffer_writeTile_RGBA8(void * _fb, struct Tile &tile);
    extern void LocalFrameBuffer_writeTile_SRGBA(void * _fb, struct Tile &tile);

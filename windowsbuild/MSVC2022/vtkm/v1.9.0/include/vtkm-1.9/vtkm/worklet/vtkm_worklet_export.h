...
//============================================================================
#ifndef VTKM_WORKLET_EXPORT_H
#define VTKM_WORKLET_EXPORT_H
...
# if 1
    /* This is a static component and has no need for exports
       ...
       use case
    */
#   define VTKM_WORKLET_EXPORT_DEFINE
#   define VTKM_WORKLET_IMPORT_DEFINE
#   define VTKM_WORKLET_NO_EXPORT_DEFINE
# else
#   define VTKM_WORKLET_EXPORT_DEFINE __declspec(dllexport)
#   define VTKM_WORKLET_IMPORT_DEFINE __declspec(dllimport)
#   define VTKM_WORKLET_NO_EXPORT_DEFINE
# endif
#else
...
#ifndef VTKM_WORKLET_EXPORT
# if defined(vtkm_worklet_EXPORTS)
    /* We are building this library */
#   define VTKM_WORKLET_EXPORT VTKM_WORKLET_EXPORT_DEFINE
# else
...
#ifndef VTKM_WORKLET_TEMPLATE_EXPORT
# if defined(vtkm_worklet_EXPORTS) && defined(_MSC_VER)
...
#   define VTKM_WORKLET_TEMPLATE_EXPORT
# elif defined(vtkm_worklet_EXPORTS)
    /* We are building this library */
#   define VTKM_WORKLET_TEMPLATE_EXPORT VTKM_WORKLET_EXPORT_DEFINE
# else
    /* We are using this library */

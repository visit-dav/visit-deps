...
//============================================================================
#ifndef VTKM_CONT_TESTING_EXPORT_H
#define VTKM_CONT_TESTING_EXPORT_H
...
# if 1
    /* This is a static component and has no need for exports
       ...
       use case
    */
#   define VTKM_CONT_TESTING_EXPORT_DEFINE
#   define VTKM_CONT_TESTING_IMPORT_DEFINE
#   define VTKM_CONT_TESTING_NO_EXPORT_DEFINE
# else
#   define VTKM_CONT_TESTING_EXPORT_DEFINE __declspec(dllexport)
#   define VTKM_CONT_TESTING_IMPORT_DEFINE __declspec(dllimport)
#   define VTKM_CONT_TESTING_NO_EXPORT_DEFINE
# endif
#else
...
#ifndef VTKM_CONT_TESTING_EXPORT
# if defined(vtkm_cont_testing_EXPORTS)
    /* We are building this library */
#   define VTKM_CONT_TESTING_EXPORT VTKM_CONT_TESTING_EXPORT_DEFINE
# else
...
#ifndef VTKM_CONT_TESTING_TEMPLATE_EXPORT
# if defined(vtkm_cont_testing_EXPORTS) && defined(_MSC_VER)
...
#   define VTKM_CONT_TESTING_TEMPLATE_EXPORT
# elif defined(vtkm_cont_testing_EXPORTS)
    /* We are building this library */
#   define VTKM_CONT_TESTING_TEMPLATE_EXPORT VTKM_CONT_TESTING_EXPORT_DEFINE
# else
    /* We are using this library */
...
#ifndef VTKM_CONT_TESTING_NO_EXPORT

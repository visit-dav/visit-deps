...
get_target_property(_qt_imported_implib Qt6::Core IMPORTED_IMPLIB_RELEASE)
...
if(_qt_imported_implib)
    set_property(TARGET Qt6::Core PROPERTY IMPORTED_IMPLIB_RELWITHDEBINFO "${_qt_imported_implib}")
endif()

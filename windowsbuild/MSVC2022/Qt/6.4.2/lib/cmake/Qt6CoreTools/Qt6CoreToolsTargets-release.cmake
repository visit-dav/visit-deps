...
set_target_properties(Qt6::moc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./bin/moc.exe"
  )
...
set_target_properties(Qt6::rcc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./bin/rcc.exe"
  )
...
set_target_properties(Qt6::tracegen PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./bin/tracegen.exe"
  )
...
set_target_properties(Qt6::cmake_automoc_parser PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./bin/cmake_automoc_parser.exe"
  )
...
set_target_properties(Qt6::qlalr PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./bin/qlalr.exe"
  )
...
set_target_properties(Qt6::qtpaths PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/qtpaths.exe"
  )
...
set_target_properties(Qt6::windeployqt PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/windeployqt.exe"
  )

list(APPEND _cmake_import_check_targets Qt6::windeployqt )
list(APPEND _cmake_import_check_files_for_Qt6::windeployqt "${_IMPORT_PREFIX}/bin/windeployqt.exe" )
...
set_target_properties(Qt6::qmake PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/qmake.exe"
  )

list(APPEND _cmake_import_check_targets Qt6::qmake )
list(APPEND _cmake_import_check_files_for_Qt6::qmake "${_IMPORT_PREFIX}/bin/qmake.exe" )

...
if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/Qt6LinguistDependencies.cmake")
    ...
    _qt_internal_suggest_dependency_debugging(Linguist
        __qt_Linguist_pkg ${CMAKE_FIND_PACKAGE_NAME}_NOT_FOUND_MESSAGE)
endif()
...
if (NOT QT_NO_CREATE_TARGETS AND Qt6Linguist_FOUND)
...
if (TARGET Qt6::Linguist)
    ...
    if(NOT DEFINED Qt6Linguist_NOT_FOUND_MESSAGE)
        set(Qt6Linguist_NOT_FOUND_MESSAGE
            "Target \"Qt6::Linguist\" was not found.")

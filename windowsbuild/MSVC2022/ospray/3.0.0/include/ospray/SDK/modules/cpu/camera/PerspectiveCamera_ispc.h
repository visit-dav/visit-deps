//
// C:/A_VisIt/TPBuilds/BuildVTK/OSPRAY/src/OSPRAY-build/ospray/build/modules/cpu/camera/PerspectiveCamera_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  PerspectiveCamera_initRayMB_addr();
    extern void *  PerspectiveCamera_initRay_addr();
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

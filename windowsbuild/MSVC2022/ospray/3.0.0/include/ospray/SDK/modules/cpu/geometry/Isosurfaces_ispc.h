//
// C:/A_VisIt/TPBuilds/BuildVTK/OSPRAY/src/OSPRAY-build/ospray/build/modules/cpu/geometry/Isosurfaces_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void Isosurfaces_bounds(const struct RTCBoundsFunctionArguments * args);
    extern void *  Isosurfaces_postIntersect_addr();
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

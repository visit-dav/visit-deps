//
// C:/A_VisIt/TPBuilds/BuildVTK/OSPRAY/src/OSPRAY-build/ospray/build/modules/cpu/render/debug/DebugRenderer_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void DebugRenderer_renderTasks(void * _self, void * _fb, void * _camera, void * _world, void * _taskIDs, uint32_t numTasks);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

//
// C:/A_VisIt/TPBuilds/BuildVTK/OSPRAY/src/OSPRAY-build/ospray/build/modules/cpu/render/materials/Principled_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  Principled_getBSDF_addr();
    extern void *  Principled_getTransparency_addr();
    extern void *  Principled_selectNextMedium_addr();
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

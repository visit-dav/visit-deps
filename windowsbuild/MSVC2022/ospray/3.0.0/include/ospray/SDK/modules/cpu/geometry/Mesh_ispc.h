//
// C:/A_VisIt/TPBuilds/BuildVTK/OSPRAY/src/OSPRAY-build/ospray/build/modules/cpu/geometry/Mesh_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  Mesh_getAreas_addr();
    extern void *  Mesh_sampleArea_addr();
    extern void *  QuadMesh_postIntersect_addr();
    extern void *  TriangleMesh_postIntersect_addr();
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

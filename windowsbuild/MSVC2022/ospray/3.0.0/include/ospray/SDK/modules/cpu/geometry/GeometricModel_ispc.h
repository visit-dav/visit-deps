//
// C:/A_VisIt/TPBuilds/BuildVTK/OSPRAY/src/OSPRAY-build/ospray/build/modules/cpu/geometry/GeometricModel_ispc.h
...
extern "C" {
    ...
    extern int32_t GeometricModel_gatherEmissivePrimIDs(void * _model, void * _renderer, void * _instance, int32_t * primIDs, float * distribution, float &pdf);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

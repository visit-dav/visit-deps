//
// C:/A_VisIt/TPBuilds/BuildVTK/OSPRAY/src/OSPRAY-build/ospray/build/modules/cpu/render/Renderer_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void Renderer_pick(const void * _self, const void * __anon_parameter_1, const void * _camera, const void * _world, const struct vec2f &screenPos, struct vec3f &pos, int32_t &instID, int32_t &geomID, int32_t &primID, int32_t &hit);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

//
// C:/A_VisIt/TPBuilds/BuildVTK/OSPRAY/src/OSPRAY-build/ospray/build/modules/cpu/lights/HDRILight_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern float Distribution1D_create(const int32_t size, float * cdf);
    extern void *  HDRILight_eval_addr();
    extern void *  HDRILight_eval_instanced_addr();
    extern void HDRILight_initDistribution(const void * _map, void * _distribution);
    extern void *  HDRILight_sample_addr();
    extern void *  HDRILight_sample_instanced_addr();
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

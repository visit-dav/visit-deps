//
// C:/A_VisIt/TPBuilds/BuildVTK/OSPRAY/src/OSPRAY-build/ospray/build/modules/cpu/lights/QuadLight_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void QuadLight_Transform(const void * self, const void * xfm, void * dyn);
    extern void *  QuadLight_eval_addr();
    extern void *  QuadLight_eval_instanced_addr();
    extern void *  QuadLight_sample_addr();
    extern void *  QuadLight_sample_instanced_addr();
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

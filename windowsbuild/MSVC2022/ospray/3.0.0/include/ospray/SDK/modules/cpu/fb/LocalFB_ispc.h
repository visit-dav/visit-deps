//
// C:/A_VisIt/TPBuilds/BuildVTK/OSPRAY/src/OSPRAY-build/ospray/build/modules/cpu/fb/LocalFB_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  LocalFrameBuffer_accumulateSample_addr();
    extern void *  LocalFrameBuffer_completeTask_addr();
    extern void *  LocalFrameBuffer_getRenderTaskDesc_addr();
    extern void LocalFrameBuffer_writeAuxTile(void * _fb, const void * _tile, void * _aux, const void * _ax, const void * _ay, const void * _az);
    extern void LocalFrameBuffer_writeDepthTile(void * _fb, const void * _tile);
    extern void LocalFrameBuffer_writeIDTile(void * _fb, const void * _tile, uint32_t * dst, const void * src);
    extern void LocalFrameBuffer_writeTile_RGBA32F(void * _fb, const void * _tile);
    extern void LocalFrameBuffer_writeTile_RGBA8(void * _fb, const void * _tile);
    extern void LocalFrameBuffer_writeTile_SRGBA(void * _fb, const void * _tile);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

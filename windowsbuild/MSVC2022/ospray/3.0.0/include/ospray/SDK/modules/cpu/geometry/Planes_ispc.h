//
// C:/A_VisIt/TPBuilds/BuildVTK/OSPRAY/src/OSPRAY-build/ospray/build/modules/cpu/geometry/Planes_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void Planes_bounds(const struct RTCBoundsFunctionArguments * args);
    extern void Planes_intersect(const struct RTCIntersectFunctionNArguments * args);
    extern void Planes_occluded(const struct RTCOccludedFunctionNArguments * args);
    extern void *  Planes_postIntersect_addr();
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

//
// C:/A_VisIt/TPBuilds/BuildVTK/OSPRAY/src/OSPRAY-build/ospray/build/modules/cpu/render/materials/ThinGlass_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  ThinGlass_getBSDF_addr();
    extern void *  ThinGlass_getTransparency_addr();
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

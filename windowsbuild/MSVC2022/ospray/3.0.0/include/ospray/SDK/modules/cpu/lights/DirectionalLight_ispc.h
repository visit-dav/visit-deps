//
// C:/A_VisIt/TPBuilds/BuildVTK/OSPRAY/src/OSPRAY-build/ospray/build/modules/cpu/lights/DirectionalLight_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  DirectionalLight_eval_addr();
    extern void *  DirectionalLight_eval_instanced_addr();
    extern void *  DirectionalLight_sample_addr();
    extern void *  DirectionalLight_sample_instanced_addr();
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

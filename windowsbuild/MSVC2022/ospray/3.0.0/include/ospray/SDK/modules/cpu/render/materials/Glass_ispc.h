//
// C:/A_VisIt/TPBuilds/BuildVTK/OSPRAY/src/OSPRAY-build/ospray/build/modules/cpu/render/materials/Glass_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void *  Glass_getBSDF_addr();
    extern void *  Glass_getTransparency_addr();
    extern void *  Glass_selectNextMedium_addr();
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

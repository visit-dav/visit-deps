//
// C:/A_VisIt/TPBuilds/BuildVTK/OSPRAY/src/OSPRAY-build/ospray/build/modules/cpu/geometry/Spheres_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void Spheres_bounds(const struct RTCBoundsFunctionArguments * args);
    extern void *  Spheres_getAreas_addr();
    extern void *  Spheres_postIntersect_addr();
    extern void *  Spheres_sampleArea_addr();
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus

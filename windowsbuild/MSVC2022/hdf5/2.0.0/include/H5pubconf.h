...
#define H5_DEFAULT_PLUGINDIR "C:/A_VisIt/Develop/visit-deps/windowsbuild/MSVC2022/hdf5/2.0.0\\lib\\plugin;%ALLUSERSPROFILE%\\hdf5\\lib\\plugin"
...
#else
/* Define if we have multi-threaded concurrency support */
/* #undef H5_HAVE_CONCURRENCY */
#endif

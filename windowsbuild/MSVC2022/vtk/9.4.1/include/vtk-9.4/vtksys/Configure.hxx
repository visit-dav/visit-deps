...
#  define vtksys_has_cpp_attribute(x) __has_attribute(x)
#elif defined(__has_cpp_attribute)
#  define vtksys_has_cpp_attribute(x) __has_cpp_attribute(x)
#else
#  define vtksys_has_cpp_attribute(x) 0
#endif
...
#  if __cplusplus >= 201703L &&                                               \
    vtksys_has_cpp_attribute(fallthrough)
#    define vtksys_FALLTHROUGH [[fallthrough]]
#  elif __cplusplus >= 201103L &&                                             \
    vtksys_has_cpp_attribute(gnu::fallthrough)
#    define vtksys_FALLTHROUGH [[gnu::fallthrough]]
#  elif __cplusplus >= 201103L &&                                             \
    vtksys_has_cpp_attribute(clang::fallthrough)
...
#undef vtksys_has_cpp_attribute

...
set_target_properties(VTK::RenderingVolumeAMR PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkRenderingVolumeAMR-9.2.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkRenderingVolumeAMR-9.2.dll"
  )
...
set_target_properties(VTK::RenderingRayTracing PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkRenderingRayTracing-9.2.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkRenderingRayTracing-9.2.dll"
  )
...
set_target_properties(VTK::WrappingPythonCore PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkWrappingPythonCore3.7-9.2.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkWrappingPythonCore3.7-9.2.dll"
  )

list(APPEND _cmake_import_check_targets VTK::WrappingPythonCore )
list(APPEND _cmake_import_check_files_for_VTK::WrappingPythonCore "${_IMPORT_PREFIX}/lib/vtkWrappingPythonCore3.7-9.2.lib" "${_IMPORT_PREFIX}/bin/vtkWrappingPythonCore3.7-9.2.dll" )
...
set_target_properties(VTK::GUISupportQt PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkGUISupportQt-9.2.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkGUISupportQt-9.2.dll"
  )

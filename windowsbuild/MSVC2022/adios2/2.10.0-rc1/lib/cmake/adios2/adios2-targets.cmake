...
foreach(_cmake_expected_target IN ITEMS adios2::adios2sys adios2::adios2sys_private adios2::nlohmann_json_wrapper adios2::core adios2::core_mpi adios2::adios2_blosc2)
...
# Create imported target adios2::adios2_blosc2
add_library(adios2::adios2_blosc2 INTERFACE IMPORTED)

set_target_properties(adios2::adios2_blosc2 PROPERTIES
  INTERFACE_LINK_LIBRARIES "Blosc2::Blosc2"
)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/adios2-targets-*.cmake")
